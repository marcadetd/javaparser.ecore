 ...
 * <!-- end-user-doc -->
 * @see fr.centralesupelec.csd.ejava.EJavaPackage#getUnaryOperator()
 * @model
 * @generated
 */
public enum UnaryOperator implements Enumerator {
    ...
    public static UnaryOperator get( int value ) {
        ...
        case MINUS_VALUE:
            return MINUS;
        case PREFIX_INCREMENT_VALUE:
            return PREFIX_INCREMENT;
        case PREFIX_DECREMENT_VALUE:
            return PREFIX_DECREMENT;
        case LOGICAL_COMPLEMENT_VALUE:
            return LOGICAL_COMPLEMENT;
        case BITWISE_COMPLEMENT_VALUE:
            return BITWISE_COMPLEMENT;
        case POSTFIX_INCREMENT_VALUE:
            return POSTFIX_INCREMENT;
        case POSTFIX_DECREMENT_VALUE:
