 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.AnnotationExprImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AnnotationExprImpl extends ExpressionImpl implements AnnotationExpr {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.ANNOTATION_EXPR;
    }
    ...
    public NotificationChain basicSetName( Name newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.ANNOTATION_EXPR__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.ANNOTATION_EXPR__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.ANNOTATION_EXPR__NAME, newName,
                    newName ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithName.class ) {
            ...
            case EJavaPackage.NODE_WITH_NAME__NAME:
                return EJavaPackage.ANNOTATION_EXPR__NAME;
            default:
                return -1;
            }
        }
