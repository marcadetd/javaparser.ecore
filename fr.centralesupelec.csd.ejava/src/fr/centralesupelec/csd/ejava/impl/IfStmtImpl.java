 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.IfStmtImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.IfStmtImpl#getThenStmt <em>Then Stmt</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.IfStmtImpl#getElseStmt <em>Else Stmt</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfStmtImpl extends StatementImpl implements IfStmt {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.IF_STMT;
    }
    ...
    public NotificationChain basicSetCondition( Expression newCondition, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.IF_STMT__CONDITION, oldCondition, newCondition );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newCondition != condition ) {
            ...
            if( condition != null )
                msgs = ( ( InternalEObject ) condition ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.IF_STMT__CONDITION, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.IF_STMT__CONDITION, newCondition,
                    newCondition ) );
    }
    ...
    public NotificationChain basicSetThenStmt( Statement newThenStmt, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.IF_STMT__THEN_STMT, oldThenStmt, newThenStmt );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newThenStmt != thenStmt ) {
            ...
            if( thenStmt != null )
                msgs = ( ( InternalEObject ) thenStmt ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.IF_STMT__THEN_STMT, null, msgs );
            if( newThenStmt != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.IF_STMT__THEN_STMT, newThenStmt,
                    newThenStmt ) );
    }
    ...
    public NotificationChain basicSetElseStmt( Statement newElseStmt, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.IF_STMT__ELSE_STMT, oldElseStmt, newElseStmt );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newElseStmt != elseStmt ) {
            ...
            if( elseStmt != null )
                msgs = ( ( InternalEObject ) elseStmt ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.IF_STMT__ELSE_STMT, null, msgs );
            if( newElseStmt != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.IF_STMT__ELSE_STMT, newElseStmt,
                    newElseStmt ) );
    }
    ...
    public NotificationChain eInverseRemove( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case EJavaPackage.IF_STMT__CONDITION:
            return basicSetCondition( null, msgs );
        case EJavaPackage.IF_STMT__THEN_STMT:
            return basicSetThenStmt( null, msgs );
        case EJavaPackage.IF_STMT__ELSE_STMT:
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithCondition.class ) {
            ...
            case EJavaPackage.NODE_WITH_CONDITION__CONDITION:
                return EJavaPackage.IF_STMT__CONDITION;
            default:
                return -1;
            }
        }
