...
public class DoStmtImpl extends StatementImpl implements DoStmt {
    ...
    public NotificationChain basicSetBody( Statement newBody, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET, JavaPackage.DO_STMT__BODY,
                    oldBody, newBody );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newBody != body ) {
            ...
            if( body != null )
                msgs = ( ( InternalEObject ) body ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.DO_STMT__BODY, null, msgs );
            if( newBody != null )
    ...
    public NotificationChain basicSetCondition( Expression newCondition, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.DO_STMT__CONDITION, oldCondition, newCondition );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newCondition != condition ) {
            ...
            if( condition != null )
                msgs = ( ( InternalEObject ) condition ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.DO_STMT__CONDITION, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.DO_STMT__CONDITION, newCondition,
                    newCondition ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithBody.class ) {
            ...
            case JavaPackage.NODE_WITH_BODY__BODY:
                return JavaPackage.DO_STMT__BODY;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithCondition.class ) {
            ...
            case JavaPackage.NODE_WITH_CONDITION__CONDITION:
                return JavaPackage.DO_STMT__CONDITION;
            default:
                return -1;
            }
        }
