 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.AnnotationDeclarationImpl#isAbstract <em>Abstract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationDeclarationImpl extends TypeDeclarationImpl implements AnnotationDeclaration {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.ANNOTATION_DECLARATION;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithAbstractModifier.class ) {
            ...
            case EJavaPackage.NODE_WITH_ABSTRACT_MODIFIER__ABSTRACT:
                return EJavaPackage.ANNOTATION_DECLARATION__ABSTRACT;
            default:
                return -1;
            }
        }
