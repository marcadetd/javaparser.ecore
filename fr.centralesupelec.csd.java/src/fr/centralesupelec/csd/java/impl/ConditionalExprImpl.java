...
public class ConditionalExprImpl extends ExpressionImpl implements ConditionalExpr {
    ...
    public NotificationChain basicSetCondition( Expression newCondition, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.CONDITIONAL_EXPR__CONDITION, oldCondition, newCondition );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newCondition != condition ) {
            ...
            if( condition != null )
                msgs = ( ( InternalEObject ) condition ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.CONDITIONAL_EXPR__CONDITION, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.CONDITIONAL_EXPR__CONDITION,
    ...
    public NotificationChain basicSetThenExpr( Expression newThenExpr, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.CONDITIONAL_EXPR__THEN_EXPR, oldThenExpr, newThenExpr );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newThenExpr != thenExpr ) {
            ...
            if( thenExpr != null )
                msgs = ( ( InternalEObject ) thenExpr ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.CONDITIONAL_EXPR__THEN_EXPR, null, msgs );
            if( newThenExpr != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.CONDITIONAL_EXPR__THEN_EXPR,
    ...
    public NotificationChain basicSetElseExpr( Expression newElseExpr, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.CONDITIONAL_EXPR__ELSE_EXPR, oldElseExpr, newElseExpr );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newElseExpr != elseExpr ) {
            ...
            if( elseExpr != null )
                msgs = ( ( InternalEObject ) elseExpr ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.CONDITIONAL_EXPR__ELSE_EXPR, null, msgs );
            if( newElseExpr != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.CONDITIONAL_EXPR__ELSE_EXPR,
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithCondition.class ) {
            ...
            case JavaPackage.NODE_WITH_CONDITION__CONDITION:
                return JavaPackage.CONDITIONAL_EXPR__CONDITION;
            default:
                return -1;
            }
        }
