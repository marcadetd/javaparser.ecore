 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.TryStmtImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.TryStmtImpl#getTryBlock <em>Try Block</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.TryStmtImpl#getCatchClauses <em>Catch Clauses</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.TryStmtImpl#getFinallyBlock <em>Finally Block</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TryStmtImpl extends StatementImpl implements TryStmt {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.TRY_STMT;
    }
    ...
    public EList< Expression > getResources() {
        if( resources == null ) {
            resources = new EObjectContainmentEList< Expression >( Expression.class, this,
                    EJavaPackage.TRY_STMT__RESOURCES );
        }
        return resources;
    }
    ...
    public NotificationChain basicSetTryBlock( BlockStmt newTryBlock, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.TRY_STMT__TRY_BLOCK, oldTryBlock, newTryBlock );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newTryBlock != tryBlock ) {
            ...
            if( tryBlock != null )
                msgs = ( ( InternalEObject ) tryBlock ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.TRY_STMT__TRY_BLOCK, null, msgs );
            if( newTryBlock != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.TRY_STMT__TRY_BLOCK, newTryBlock,
                    newTryBlock ) );
    }
    ...
    public EList< CatchClause > getCatchClauses() {
        if( catchClauses == null ) {
            catchClauses = new EObjectContainmentEList< CatchClause >( CatchClause.class, this,
                    EJavaPackage.TRY_STMT__CATCH_CLAUSES );
        }
        return catchClauses;
    }
    ...
    public NotificationChain basicSetFinallyBlock( BlockStmt newFinallyBlock, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.TRY_STMT__FINALLY_BLOCK, oldFinallyBlock, newFinallyBlock );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newFinallyBlock != finallyBlock ) {
            ...
            if( finallyBlock != null )
                msgs = ( ( InternalEObject ) finallyBlock ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.TRY_STMT__FINALLY_BLOCK, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.TRY_STMT__FINALLY_BLOCK,
