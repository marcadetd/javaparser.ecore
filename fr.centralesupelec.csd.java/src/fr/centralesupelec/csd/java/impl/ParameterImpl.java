...
public class ParameterImpl extends JavaNodeImpl implements Parameter {
    ...
    public NotificationChain basicSetType( Type newType, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET, JavaPackage.PARAMETER__TYPE,
                    oldType, newType );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newType != type ) {
            ...
            if( type != null )
                msgs = ( ( InternalEObject ) type ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.PARAMETER__TYPE, null, msgs );
            if( newType != null )
    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    JavaPackage.PARAMETER__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public NotificationChain basicSetName( SimpleName newName, NotificationChain msgs ) {
        ...
        name = newName;
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET, JavaPackage.PARAMETER__NAME,
                    oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.PARAMETER__NAME, null, msgs );
            if( newName != null )
    ...
    public EList< ModifierKeyword > getModifiers() {
        if( modifiers == null ) {
            modifiers = new EDataTypeUniqueEList< ModifierKeyword >( ModifierKeyword.class, this,
                    JavaPackage.PARAMETER__MODIFIERS );
        }
        return modifiers;
    }
    ...
    public void setVarArgs( boolean newVarArgs ) {
        ...
        varArgs = newVarArgs;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.PARAMETER__VAR_ARGS, oldVarArgs,
                    varArgs ) );
    }
    ...
    public EList< AnnotationExpr > getVarArgsAnnotations() {
        if( varArgsAnnotations == null ) {
            varArgsAnnotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    JavaPackage.PARAMETER__VAR_ARGS_ANNOTATIONS );
        }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithType.class ) {
            ...
            case JavaPackage.NODE_WITH_TYPE__TYPE:
                return JavaPackage.PARAMETER__TYPE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case JavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return JavaPackage.PARAMETER__ANNOTATIONS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithSimpleName.class ) {
            ...
            case JavaPackage.NODE_WITH_SIMPLE_NAME__NAME:
                return JavaPackage.PARAMETER__NAME;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithModifiers.class ) {
            ...
            case JavaPackage.NODE_WITH_MODIFIERS__MODIFIERS:
                return JavaPackage.PARAMETER__MODIFIERS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithFinalModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_FINAL_MODIFIER__FINAL:
                return JavaPackage.PARAMETER__FINAL;
            default:
                return -1;
            }
        }
