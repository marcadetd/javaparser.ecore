...
public class ReceiverParameterImpl extends JavaNodeImpl implements ReceiverParameter {
    ...
    public NotificationChain basicSetType( Type newType, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.RECEIVER_PARAMETER__TYPE, oldType, newType );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newType != type ) {
            ...
            if( type != null )
                msgs = ( ( InternalEObject ) type ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.RECEIVER_PARAMETER__TYPE, null, msgs );
            if( newType != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.RECEIVER_PARAMETER__TYPE, newType,
                    newType ) );
    }
    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    JavaPackage.RECEIVER_PARAMETER__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public NotificationChain basicSetName( Name newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.RECEIVER_PARAMETER__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.RECEIVER_PARAMETER__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.RECEIVER_PARAMETER__NAME, newName,
                    newName ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithType.class ) {
            ...
            case JavaPackage.NODE_WITH_TYPE__TYPE:
                return JavaPackage.RECEIVER_PARAMETER__TYPE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case JavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return JavaPackage.RECEIVER_PARAMETER__ANNOTATIONS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithName.class ) {
            ...
            case JavaPackage.NODE_WITH_NAME__NAME:
                return JavaPackage.RECEIVER_PARAMETER__NAME;
            default:
                return -1;
            }
        }
