 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.ModuleProvidesDirective#getWith <em>With</em>}</li>
 * </ul>
 *
 * @see fr.centralesupelec.csd.ejava.EJavaPackage#getModuleProvidesDirective()
 * @model
 * @generated
 */
public interface ModuleProvidesDirective extends ModuleDirective, NodeWithName {
     ...
     * @see fr.centralesupelec.csd.ejava.EJavaPackage#getModuleProvidesDirective_With()
