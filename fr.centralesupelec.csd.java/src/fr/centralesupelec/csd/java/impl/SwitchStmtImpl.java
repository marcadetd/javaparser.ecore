    ...
    public NotificationChain basicSetSelector( Expression newSelector, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.SWITCH_STMT__SELECTOR, oldSelector, newSelector );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newSelector != selector ) {
            ...
            if( selector != null )
                msgs = ( ( InternalEObject ) selector ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.SWITCH_STMT__SELECTOR, null, msgs );
            if( newSelector != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.SWITCH_STMT__SELECTOR, newSelector,
                    newSelector ) );
    }
    ...
    public EList< SwitchEntry > getEntries() {
        if( entries == null ) {
            entries = new EObjectContainmentEList< SwitchEntry >( SwitchEntry.class, this,
                    JavaPackage.SWITCH_STMT__ENTRIES );
        }
        return entries;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == SwitchNode.class ) {
            ...
            case JavaPackage.SWITCH_NODE__SELECTOR:
                return JavaPackage.SWITCH_STMT__SELECTOR;
            case JavaPackage.SWITCH_NODE__ENTRIES:
                return JavaPackage.SWITCH_STMT__ENTRIES;
            default:
                return -1;
            }
        }
