...
public class IfStmtImpl extends StatementImpl implements IfStmt {
	...
	public NotificationChain basicSetCondition(Expression newCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.IF_STMT__CONDITION, oldCondition, newCondition);
	...
	public void setCondition(Expression newCondition) {
        if (newCondition != condition) {
            ...
            if (condition != null)
                msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.IF_STMT__CONDITION, null, msgs);
            if (newCondition != null)
                msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.IF_STMT__CONDITION, null, msgs);
            msgs = basicSetCondition(newCondition, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.IF_STMT__CONDITION, newCondition, newCondition));
    }
	...
	public NotificationChain basicSetThenStmt(Statement newThenStmt, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.IF_STMT__THEN_STMT, oldThenStmt, newThenStmt);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
	...
	public void setThenStmt(Statement newThenStmt) {
        if (newThenStmt != thenStmt) {
            NotificationChain msgs = null;
            if (thenStmt != null)
                msgs = ((InternalEObject)thenStmt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.IF_STMT__THEN_STMT, null, msgs);
            if (newThenStmt != null)
                msgs = ((InternalEObject)newThenStmt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.IF_STMT__THEN_STMT, null, msgs);
            msgs = basicSetThenStmt(newThenStmt, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.IF_STMT__THEN_STMT, newThenStmt, newThenStmt));
    }
	...
	public NotificationChain basicSetElseStmt(Statement newElseStmt, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.IF_STMT__ELSE_STMT, oldElseStmt, newElseStmt);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
	...
	public void setElseStmt(Statement newElseStmt) {
        if (newElseStmt != elseStmt) {
            NotificationChain msgs = null;
            if (elseStmt != null)
                msgs = ((InternalEObject)elseStmt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.IF_STMT__ELSE_STMT, null, msgs);
            if (newElseStmt != null)
                msgs = ((InternalEObject)newElseStmt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.IF_STMT__ELSE_STMT, null, msgs);
            msgs = basicSetElseStmt(newElseStmt, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.IF_STMT__ELSE_STMT, newElseStmt, newElseStmt));
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithCondition.class) {
            switch (derivedFeatureID) {
                case JavaPackage.IF_STMT__CONDITION: return JavaPackage.NODE_WITH_CONDITION__CONDITION;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithCondition.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_CONDITION__CONDITION: return JavaPackage.IF_STMT__CONDITION;
                default: return -1;
            }
        }
