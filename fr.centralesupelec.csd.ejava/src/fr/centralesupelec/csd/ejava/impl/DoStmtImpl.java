 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.DoStmtImpl#getBody <em>Body</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.DoStmtImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoStmtImpl extends StatementImpl implements DoStmt {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.DO_STMT;
    }
    ...
    public NotificationChain basicSetBody( Statement newBody, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET, EJavaPackage.DO_STMT__BODY,
                    oldBody, newBody );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newBody != body ) {
            ...
            if( body != null )
                msgs = ( ( InternalEObject ) body ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.DO_STMT__BODY, null, msgs );
            if( newBody != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.DO_STMT__BODY, newBody, newBody ) );
    }
    ...
    public NotificationChain basicSetCondition( Expression newCondition, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.DO_STMT__CONDITION, oldCondition, newCondition );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newCondition != condition ) {
            ...
            if( condition != null )
                msgs = ( ( InternalEObject ) condition ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.DO_STMT__CONDITION, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.DO_STMT__CONDITION, newCondition,
                    newCondition ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithBody.class ) {
            ...
            case EJavaPackage.NODE_WITH_BODY__BODY:
                return EJavaPackage.DO_STMT__BODY;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithCondition.class ) {
            ...
            case EJavaPackage.NODE_WITH_CONDITION__CONDITION:
                return EJavaPackage.DO_STMT__CONDITION;
            default:
                return -1;
            }
        }
