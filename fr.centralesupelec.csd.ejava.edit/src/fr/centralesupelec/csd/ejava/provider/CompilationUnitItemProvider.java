...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.csd.ejava.CompilationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompilationUnitItemProvider extends JavaNodeItemProvider {
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( EJavaPackage.Literals.COMPILATION_UNIT__MODULE );
        }
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( EJavaPackage.Literals.COMPILATION_UNIT__IMPORTS,
                EJavaFactory.eINSTANCE.createImportDeclaration() ) );

        newChildDescriptors.add( createChildParameter( EJavaPackage.Literals.COMPILATION_UNIT__TYPES,
        ...
        newChildDescriptors.add( createChildParameter( EJavaPackage.Literals.COMPILATION_UNIT__MODULE,
