...
public class ModuleDeclarationImpl extends MinimalEObjectImpl.Container implements ModuleDeclaration {
	...
	public NotificationChain basicSetName(Name newName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.MODULE_DECLARATION__NAME, oldName, newName);
	...
	public void setName(Name newName) {
        if (newName != name) {
            ...
            if (name != null)
                msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.MODULE_DECLARATION__NAME, null, msgs);
            if (newName != null)
                msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.MODULE_DECLARATION__NAME, null, msgs);
            msgs = basicSetName(newName, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.MODULE_DECLARATION__NAME, newName, newName));
    }
	...
	public EList<AnnotationExpr> getAnnotations() {
        if (annotations == null) {
            annotations = new EObjectContainmentEList<AnnotationExpr>(AnnotationExpr.class, this, JavaPackage.MODULE_DECLARATION__ANNOTATIONS);
        }
        return annotations;
    }
	...
	public void setOpen(boolean newOpen) {
        ...
        open = newOpen;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.MODULE_DECLARATION__OPEN, oldOpen, open));
    }
	...
	public EList<ModuleDirective> getDirectives() {
        if (directives == null) {
            directives = new EObjectContainmentEList<ModuleDirective>(ModuleDirective.class, this, JavaPackage.MODULE_DECLARATION__DIRECTIVES);
        }
        return directives;
    }
