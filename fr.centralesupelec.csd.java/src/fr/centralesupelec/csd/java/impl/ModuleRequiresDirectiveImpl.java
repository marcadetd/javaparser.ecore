...
public class ModuleRequiresDirectiveImpl extends ModuleDirectiveImpl implements ModuleRequiresDirective {
	...
	public NotificationChain basicSetName(Name newName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.MODULE_REQUIRES_DIRECTIVE__NAME, oldName, newName);
	...
	public void setName(Name newName) {
        if (newName != name) {
            ...
            if (name != null)
                msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.MODULE_REQUIRES_DIRECTIVE__NAME, null, msgs);
            if (newName != null)
                msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.MODULE_REQUIRES_DIRECTIVE__NAME, null, msgs);
            msgs = basicSetName(newName, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.MODULE_REQUIRES_DIRECTIVE__NAME, newName, newName));
    }
	...
	public EList<ModifierKeyword> getModifiers() {
        if (modifiers == null) {
            modifiers = new EDataTypeUniqueEList<ModifierKeyword>(ModifierKeyword.class, this, JavaPackage.MODULE_REQUIRES_DIRECTIVE__MODIFIERS);
        }
        return modifiers;
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithModifiers.class) {
            switch (derivedFeatureID) {
                case JavaPackage.MODULE_REQUIRES_DIRECTIVE__MODIFIERS: return JavaPackage.NODE_WITH_MODIFIERS__MODIFIERS;
                default: return -1;
            }
        }
        if (baseClass == NodeWithStaticModifier.class) {
            switch (derivedFeatureID) {
                case JavaPackage.MODULE_REQUIRES_DIRECTIVE__STATIC: return JavaPackage.NODE_WITH_STATIC_MODIFIER__STATIC;
                default: return -1;
            }
        }
        if (baseClass == NodeWithName.class) {
            switch (derivedFeatureID) {
                case JavaPackage.MODULE_REQUIRES_DIRECTIVE__NAME: return JavaPackage.NODE_WITH_NAME__NAME;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithModifiers.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_MODIFIERS__MODIFIERS: return JavaPackage.MODULE_REQUIRES_DIRECTIVE__MODIFIERS;
                default: return -1;
            }
        }
        if (baseClass == NodeWithStaticModifier.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_STATIC_MODIFIER__STATIC: return JavaPackage.MODULE_REQUIRES_DIRECTIVE__STATIC;
                default: return -1;
            }
        }
        if (baseClass == NodeWithName.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_NAME__NAME: return JavaPackage.MODULE_REQUIRES_DIRECTIVE__NAME;
                default: return -1;
            }
        }
