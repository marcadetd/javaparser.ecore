...
public class EnumDeclarationImpl extends TypeDeclarationImpl implements EnumDeclaration {
	...
	public EList<ClassOrInterfaceType> getImplementedTypes() {
        if (implementedTypes == null) {
            implementedTypes = new EObjectContainmentEList<ClassOrInterfaceType>(ClassOrInterfaceType.class, this, JavaPackage.ENUM_DECLARATION__IMPLEMENTED_TYPES);
        }
	...
	public EList<EnumConstantDeclaration> getEntries() {
        if (entries == null) {
            entries = new EObjectContainmentEList<EnumConstantDeclaration>(EnumConstantDeclaration.class, this, JavaPackage.ENUM_DECLARATION__ENTRIES);
        }
        return entries;
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithImplements.class) {
            switch (derivedFeatureID) {
                case JavaPackage.ENUM_DECLARATION__IMPLEMENTED_TYPES: return JavaPackage.NODE_WITH_IMPLEMENTS__IMPLEMENTED_TYPES;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithImplements.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_IMPLEMENTS__IMPLEMENTED_TYPES: return JavaPackage.ENUM_DECLARATION__IMPLEMENTED_TYPES;
                default: return -1;
            }
        }
