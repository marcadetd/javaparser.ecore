...
public class CompilationUnitImpl extends JavaNodeImpl implements CompilationUnit {
    ...
    public NotificationChain basicSetPackageDeclaration( PackageDeclaration newPackageDeclaration,
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.COMPILATION_UNIT__PACKAGE_DECLARATION, oldPackageDeclaration, newPackageDeclaration );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newPackageDeclaration != packageDeclaration ) {
            ...
            if( packageDeclaration != null )
                msgs = ( ( InternalEObject ) packageDeclaration ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.COMPILATION_UNIT__PACKAGE_DECLARATION, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.COMPILATION_UNIT__PACKAGE_DECLARATION,
    ...
    public NotificationChain basicSetModule( ModuleDeclaration newModule, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.COMPILATION_UNIT__MODULE, oldModule, newModule );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newModule != module ) {
            ...
            if( module != null )
                msgs = ( ( InternalEObject ) module ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.COMPILATION_UNIT__MODULE, null, msgs );
            if( newModule != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.COMPILATION_UNIT__MODULE, newModule,
                    newModule ) );
    }
