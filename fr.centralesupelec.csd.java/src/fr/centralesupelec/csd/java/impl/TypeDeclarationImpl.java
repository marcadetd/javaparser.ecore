...
public abstract class TypeDeclarationImpl extends BodyDeclarationImpl implements TypeDeclaration {
    ...
    public NotificationChain basicSetName( SimpleName newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.TYPE_DECLARATION__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.TYPE_DECLARATION__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.TYPE_DECLARATION__NAME, newName,
                    newName ) );
    }
    ...
    public EList< BodyDeclaration > getMembers() {
        if( members == null ) {
            members = new EObjectContainmentEList< BodyDeclaration >( BodyDeclaration.class, this,
                    JavaPackage.TYPE_DECLARATION__MEMBERS );
        }
        return members;
    }
    ...
    public EList< ModifierKeyword > getModifiers() {
        if( modifiers == null ) {
            modifiers = new EDataTypeUniqueEList< ModifierKeyword >( ModifierKeyword.class, this,
                    JavaPackage.TYPE_DECLARATION__MODIFIERS );
        }
        return modifiers;
    }
    ...
    public int eBaseStructuralFeatureID( int derivedFeatureID, Class< ? > baseClass ) {
        ...
        if( baseClass == NodeWithMembers.class ) {
            switch( derivedFeatureID ) {
            case JavaPackage.TYPE_DECLARATION__MEMBERS:
                return JavaPackage.NODE_WITH_MEMBERS__MEMBERS;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithSimpleName.class ) {
            ...
            case JavaPackage.NODE_WITH_SIMPLE_NAME__NAME:
                return JavaPackage.TYPE_DECLARATION__NAME;
            default:
                return -1;
            }
        }
        ...
        if( baseClass == NodeWithMembers.class ) {
            switch( baseFeatureID ) {
            case JavaPackage.NODE_WITH_MEMBERS__MEMBERS:
                return JavaPackage.TYPE_DECLARATION__MEMBERS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithModifiers.class ) {
            ...
            case JavaPackage.NODE_WITH_MODIFIERS__MODIFIERS:
                return JavaPackage.TYPE_DECLARATION__MODIFIERS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithPublicModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_PUBLIC_MODIFIER__PUBLIC:
                return JavaPackage.TYPE_DECLARATION__PUBLIC;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithPrivateModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_PRIVATE_MODIFIER__PRIVATE:
                return JavaPackage.TYPE_DECLARATION__PRIVATE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithProtectedModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_PROTECTED_MODIFIER__PROTECTED:
                return JavaPackage.TYPE_DECLARATION__PROTECTED;
            default:
                return -1;
            }
        }
        ...
        if( baseClass == NodeWithStaticModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_STATIC_MODIFIER__STATIC:
                return JavaPackage.TYPE_DECLARATION__STATIC;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithStrictfpModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_STRICTFP_MODIFIER__STRICTFP:
                return JavaPackage.TYPE_DECLARATION__STRICTFP;
            default:
                return -1;
            }
        }
