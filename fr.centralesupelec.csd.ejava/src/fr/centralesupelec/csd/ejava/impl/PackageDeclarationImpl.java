 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.PackageDeclarationImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.PackageDeclarationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageDeclarationImpl extends JavaNodeImpl implements PackageDeclaration {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.PACKAGE_DECLARATION;
    }
    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    EJavaPackage.PACKAGE_DECLARATION__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public NotificationChain basicSetName( Name newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.PACKAGE_DECLARATION__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.PACKAGE_DECLARATION__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.PACKAGE_DECLARATION__NAME, newName,
                    newName ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case EJavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return EJavaPackage.PACKAGE_DECLARATION__ANNOTATIONS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithName.class ) {
            ...
            case EJavaPackage.NODE_WITH_NAME__NAME:
                return EJavaPackage.PACKAGE_DECLARATION__NAME;
            default:
                return -1;
            }
        }
