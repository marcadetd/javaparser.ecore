...
public class LambdaExprImpl extends ExpressionImpl implements LambdaExpr {
	...
	public EList<Parameter> getParameters() {
        if (parameters == null) {
            parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, JavaPackage.LAMBDA_EXPR__PARAMETERS);
        }
        return parameters;
    }
	...
	public void setEnclosingParameters(boolean newEnclosingParameters) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.LAMBDA_EXPR__ENCLOSING_PARAMETERS, oldEnclosingParameters, enclosingParameters));
    }
	...
	public Statement getBody() {
        if (body != null && body.eIsProxy()) {
            ...
            if (body != oldBody) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavaPackage.LAMBDA_EXPR__BODY, oldBody, body));
            }
        }
        return body;
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithParameters.class) {
            switch (derivedFeatureID) {
                case JavaPackage.LAMBDA_EXPR__PARAMETERS: return JavaPackage.NODE_WITH_PARAMETERS__PARAMETERS;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithParameters.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_PARAMETERS__PARAMETERS: return JavaPackage.LAMBDA_EXPR__PARAMETERS;
                default: return -1;
            }
        }
