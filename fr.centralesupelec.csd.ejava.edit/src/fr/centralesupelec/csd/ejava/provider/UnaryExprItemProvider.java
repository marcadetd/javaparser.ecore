...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.csd.ejava.UnaryExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryExprItemProvider extends ExpressionItemProvider {
    /**
    ...
    protected void addOperatorPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_UnaryExpr_operator_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_UnaryExpr_operator_feature",
                                "_UI_UnaryExpr_type" ),
                        EJavaPackage.Literals.UNARY_EXPR__OPERATOR,
                        true,
                        false,
                        true,
    ...
    public String getText( Object object ) {
        UnaryOperator labelValue = ( ( UnaryExpr ) object ).getOperator();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? getString( "_UI_UnaryExpr_type" )
