    ...
    public EList< ModifierKeyword > getModifiers() {
        if( modifiers == null ) {
            modifiers = new EDataTypeUniqueEList< ModifierKeyword >( ModifierKeyword.class, this,
                    JavaPackage.VARIABLE_DECLARATION_EXPR__MODIFIERS );
        }
        return modifiers;
    }
    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    JavaPackage.VARIABLE_DECLARATION_EXPR__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public EList< VariableDeclarator > getVariables() {
        if( variables == null ) {
            variables = new EObjectContainmentEList< VariableDeclarator >( VariableDeclarator.class, this,
                    JavaPackage.VARIABLE_DECLARATION_EXPR__VARIABLES );
        }
        return variables;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithModifiers.class ) {
            ...
            case JavaPackage.NODE_WITH_MODIFIERS__MODIFIERS:
                return JavaPackage.VARIABLE_DECLARATION_EXPR__MODIFIERS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithFinalModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_FINAL_MODIFIER__FINAL:
                return JavaPackage.VARIABLE_DECLARATION_EXPR__FINAL;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case JavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return JavaPackage.VARIABLE_DECLARATION_EXPR__ANNOTATIONS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithVariables.class ) {
            ...
            case JavaPackage.NODE_WITH_VARIABLES__VARIABLES:
                return JavaPackage.VARIABLE_DECLARATION_EXPR__VARIABLES;
            default:
                return -1;
            }
        }
