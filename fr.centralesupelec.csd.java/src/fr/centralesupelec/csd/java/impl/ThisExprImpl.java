...
public class ThisExprImpl extends ExpressionImpl implements ThisExpr {
	...
	public NotificationChain basicSetTypeName(Name newTypeName, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.THIS_EXPR__TYPE_NAME, oldTypeName, newTypeName);
	...
	public void setTypeName(Name newTypeName) {
        if (newTypeName != typeName) {
            ...
            if (typeName != null)
                msgs = ((InternalEObject)typeName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.THIS_EXPR__TYPE_NAME, null, msgs);
            if (newTypeName != null)
                msgs = ((InternalEObject)newTypeName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.THIS_EXPR__TYPE_NAME, null, msgs);
            msgs = basicSetTypeName(newTypeName, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.THIS_EXPR__TYPE_NAME, newTypeName, newTypeName));
    }
