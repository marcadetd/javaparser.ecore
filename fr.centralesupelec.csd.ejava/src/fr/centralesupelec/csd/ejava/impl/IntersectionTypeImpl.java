 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.IntersectionTypeImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.IntersectionTypeImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntersectionTypeImpl extends TypeImpl implements IntersectionType {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.INTERSECTION_TYPE;
    }
    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    EJavaPackage.INTERSECTION_TYPE__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public EList< ReferenceType > getElements() {
        if( elements == null ) {
            elements = new EObjectContainmentEList< ReferenceType >( ReferenceType.class, this,
                    EJavaPackage.INTERSECTION_TYPE__ELEMENTS );
        }
        return elements;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case EJavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return EJavaPackage.INTERSECTION_TYPE__ANNOTATIONS;
            default:
                return -1;
            }
        }
