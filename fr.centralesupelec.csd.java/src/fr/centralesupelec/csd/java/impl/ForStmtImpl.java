...
public class ForStmtImpl extends StatementImpl implements ForStmt {
    ...
    public NotificationChain basicSetBody( Statement newBody, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET, JavaPackage.FOR_STMT__BODY,
                    oldBody, newBody );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newBody != body ) {
            ...
            if( body != null )
                msgs = ( ( InternalEObject ) body ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.FOR_STMT__BODY, null, msgs );
            if( newBody != null )
    ...
    public EList< Expression > getInitialization() {
        if( initialization == null ) {
            initialization = new EObjectContainmentEList< Expression >( Expression.class, this,
                    JavaPackage.FOR_STMT__INITIALIZATION );
        }
    ...
    public NotificationChain basicSetCompare( Expression newCompare, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.FOR_STMT__COMPARE, oldCompare, newCompare );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newCompare != compare ) {
            ...
            if( compare != null )
                msgs = ( ( InternalEObject ) compare ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.FOR_STMT__COMPARE, null, msgs );
            if( newCompare != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.FOR_STMT__COMPARE, newCompare,
                    newCompare ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithBody.class ) {
            ...
            case JavaPackage.NODE_WITH_BODY__BODY:
                return JavaPackage.FOR_STMT__BODY;
            default:
                return -1;
            }
        }
