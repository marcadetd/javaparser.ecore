 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ModuleProvidesDirectiveImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ModuleProvidesDirectiveImpl#getWith <em>With</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleProvidesDirectiveImpl extends ModuleDirectiveImpl implements ModuleProvidesDirective {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.MODULE_PROVIDES_DIRECTIVE;
    }
    ...
    public NotificationChain basicSetName( Name newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.MODULE_PROVIDES_DIRECTIVE__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.MODULE_PROVIDES_DIRECTIVE__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.MODULE_PROVIDES_DIRECTIVE__NAME,
                    newName, newName ) );
    }
    ...
    public EList< Name > getWith() {
        if( with == null ) {
            with = new EObjectContainmentEList< Name >( Name.class, this,
                    EJavaPackage.MODULE_PROVIDES_DIRECTIVE__WITH );
        }
        return with;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithName.class ) {
            ...
            case EJavaPackage.NODE_WITH_NAME__NAME:
                return EJavaPackage.MODULE_PROVIDES_DIRECTIVE__NAME;
            default:
                return -1;
            }
        }
