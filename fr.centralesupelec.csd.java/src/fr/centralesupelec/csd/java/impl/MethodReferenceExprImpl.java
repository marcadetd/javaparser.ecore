...
public class MethodReferenceExprImpl extends ExpressionImpl implements MethodReferenceExpr {
    ...
    public EList< Type > getTypeArguments() {
        if( typeArguments == null ) {
            typeArguments = new EObjectContainmentEList< Type >( Type.class, this,
                    JavaPackage.METHOD_REFERENCE_EXPR__TYPE_ARGUMENTS );
        }
    ...
    public void setIdentifier( String newIdentifier ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.METHOD_REFERENCE_EXPR__IDENTIFIER,
    ...
    public NotificationChain basicSetScope( Expression newScope, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.METHOD_REFERENCE_EXPR__SCOPE, oldScope, newScope );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newScope != scope ) {
            ...
            if( scope != null )
                msgs = ( ( InternalEObject ) scope ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.METHOD_REFERENCE_EXPR__SCOPE, null, msgs );
            if( newScope != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.METHOD_REFERENCE_EXPR__SCOPE, newScope,
                    newScope ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithTypeArguments.class ) {
            ...
            case JavaPackage.NODE_WITH_TYPE_ARGUMENTS__TYPE_ARGUMENTS:
                return JavaPackage.METHOD_REFERENCE_EXPR__TYPE_ARGUMENTS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithIdentifier.class ) {
            ...
            case JavaPackage.NODE_WITH_IDENTIFIER__IDENTIFIER:
                return JavaPackage.METHOD_REFERENCE_EXPR__IDENTIFIER;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithScope.class ) {
            ...
            case JavaPackage.NODE_WITH_SCOPE__SCOPE:
                return JavaPackage.METHOD_REFERENCE_EXPR__SCOPE;
            default:
                return -1;
            }
        }
