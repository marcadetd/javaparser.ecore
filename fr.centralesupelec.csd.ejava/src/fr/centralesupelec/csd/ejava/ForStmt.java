 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.ForStmt#getInitialization <em>Initialization</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.ForStmt#getCompare <em>Compare</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.ForStmt#getUpdate <em>Update</em>}</li>
 * </ul>
 *
 * @see fr.centralesupelec.csd.ejava.EJavaPackage#getForStmt()
 * @model
 * @generated
 */
public interface ForStmt extends Statement, NodeWithBody {
     ...
     * @see fr.centralesupelec.csd.ejava.EJavaPackage#getForStmt_Initialization()
     ...
     * @see fr.centralesupelec.csd.ejava.EJavaPackage#getForStmt_Compare()
     * @model containment="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link fr.centralesupelec.csd.ejava.ForStmt#getCompare <em>Compare</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see fr.centralesupelec.csd.ejava.EJavaPackage#getForStmt_Update()
     * @model containment="true"
     * @generated
     */
