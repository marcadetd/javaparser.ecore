    ...
    public NotificationChain basicSetMemberValue( Expression newMemberValue, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.SINGLE_MEMBER_ANNOTATION_EXPR__MEMBER_VALUE, oldMemberValue, newMemberValue );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newMemberValue != memberValue ) {
            ...
            if( memberValue != null )
                msgs = ( ( InternalEObject ) memberValue ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.SINGLE_MEMBER_ANNOTATION_EXPR__MEMBER_VALUE, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET,
                    JavaPackage.SINGLE_MEMBER_ANNOTATION_EXPR__MEMBER_VALUE, newMemberValue, newMemberValue ) );
    }
