...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.csd.ejava.MethodDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodDeclarationItemProvider extends CallableDeclarationItemProvider {
    /**
    ...
    protected void addNativePropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_NodeWithNativeModifier_native_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_NodeWithNativeModifier_native_feature",
                                "_UI_NodeWithNativeModifier_type" ),
                        EJavaPackage.Literals.NODE_WITH_NATIVE_MODIFIER__NATIVE,
                        true,
                        false,
                        false,
    ...
    protected void addSynchronizedPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_NodeWithSynchronizedModifier_synchronized_feature" ),
                        getString( "_UI_PropertyDescriptor_description",
                                "_UI_NodeWithSynchronizedModifier_synchronized_feature",
                                "_UI_NodeWithSynchronizedModifier_type" ),
                        EJavaPackage.Literals.NODE_WITH_SYNCHRONIZED_MODIFIER__SYNCHRONIZED,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    protected void addDefaultPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor( ( ( ComposeableAdapterFactory ) adapterFactory ).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString( "_UI_NodeWithDefaultModifier_default_feature" ),
                        getString( "_UI_PropertyDescriptor_description", "_UI_NodeWithDefaultModifier_default_feature",
                                "_UI_NodeWithDefaultModifier_type" ),
                        EJavaPackage.Literals.NODE_WITH_DEFAULT_MODIFIER__DEFAULT,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    public String getCreateChildText( Object owner, Object feature, Object child, Collection< ? > selection ) {
        ...
        boolean qualify = childFeature == EJavaPackage.Literals.JAVA_NODE__COMMENT ||
                ...
                childFeature == EJavaPackage.Literals.NODE_WITH_PARAMETERS__PARAMETERS ||
                ...
                childFeature == EJavaPackage.Literals.CALLABLE_DECLARATION__RECEIVER_PARAMETER ||
                childFeature == EJavaPackage.Literals.NODE_WITH_BLOCK_STMT__BODY;
