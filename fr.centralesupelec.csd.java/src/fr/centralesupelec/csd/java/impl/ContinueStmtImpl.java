    ...
    public NotificationChain basicSetLabel( SimpleName newLabel, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.CONTINUE_STMT__LABEL, oldLabel, newLabel );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newLabel != label ) {
            ...
            if( label != null )
                msgs = ( ( InternalEObject ) label ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.CONTINUE_STMT__LABEL, null, msgs );
            if( newLabel != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.CONTINUE_STMT__LABEL, newLabel,
                    newLabel ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithLabel.class ) {
            ...
            case JavaPackage.NODE_WITH_LABEL__LABEL:
                return JavaPackage.CONTINUE_STMT__LABEL;
            default:
                return -1;
            }
        }
