...
public class NameExprImpl extends ExpressionImpl implements NameExpr {
    ...
    public NotificationChain basicSetName( SimpleName newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET, JavaPackage.NAME_EXPR__NAME,
                    oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.NAME_EXPR__NAME, null, msgs );
            if( newName != null )
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithSimpleName.class ) {
            ...
            case JavaPackage.NODE_WITH_SIMPLE_NAME__NAME:
                return JavaPackage.NAME_EXPR__NAME;
            default:
                return -1;
            }
        }
