    ...
    public NotificationChain basicSetInner( Expression newInner, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.ENCLOSED_EXPR__INNER, oldInner, newInner );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newInner != inner ) {
            ...
            if( inner != null )
                msgs = ( ( InternalEObject ) inner ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.ENCLOSED_EXPR__INNER, null, msgs );
            if( newInner != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.ENCLOSED_EXPR__INNER, newInner,
                    newInner ) );
    }
