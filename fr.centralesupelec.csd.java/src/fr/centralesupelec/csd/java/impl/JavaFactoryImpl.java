...
public class JavaFactoryImpl extends EFactoryImpl implements JavaFactory {
	...
	public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            ...
            case JavaPackage.CLASS_OR_INTERFACE_DECLARATION: return createClassOrInterfaceDeclaration();
            ...
            case JavaPackage.INITIALIZER_DECLARATION: return createInitializerDeclaration();
            case JavaPackage.METHOD_DECLARATION: return createMethodDeclaration();
            case JavaPackage.PARAMETER: return createParameter();
            case JavaPackage.RECEIVER_PARAMETER: return createReceiverParameter();
            ...
            case JavaPackage.ARRAY_ACCESS_EXPR: return createArrayAccessExpr();
            case JavaPackage.ARRAY_CREATION_EXPR: return createArrayCreationExpr();
            case JavaPackage.ARRAY_INITIALIZER_EXPR: return createArrayInitializerExpr();
            case JavaPackage.ASSIGN_EXPR: return createAssignExpr();
            case JavaPackage.BINARY_EXPR: return createBinaryExpr();
            case JavaPackage.BOOLEAN_LITERAL_EXPR: return createBooleanLiteralExpr();
            case JavaPackage.CAST_EXPR: return createCastExpr();
            case JavaPackage.CHAR_LITERAL_EXPR: return createCharLiteralExpr();
            case JavaPackage.CLASS_EXPR: return createClassExpr();
            case JavaPackage.CONDITIONAL_EXPR: return createConditionalExpr();
            case JavaPackage.DOUBLE_LITERAL_EXPR: return createDoubleLiteralExpr();
            case JavaPackage.ENCLOSED_EXPR: return createEnclosedExpr();
            case JavaPackage.FIELD_ACCESS_EXPR: return createFieldAccessExpr();
            case JavaPackage.INSTANCE_OF_EXPR: return createInstanceOfExpr();
            case JavaPackage.INTEGER_LITERAL_EXPR: return createIntegerLiteralExpr();
            case JavaPackage.LAMBDA_EXPR: return createLambdaExpr();
            case JavaPackage.LONG_LITERAL_EXPR: return createLongLiteralExpr();
            case JavaPackage.MARKER_ANNOTATION_EXPR: return createMarkerAnnotationExpr();
            case JavaPackage.MEMBER_VALUE_PAIR: return createMemberValuePair();
            case JavaPackage.METHOD_CALL_EXPR: return createMethodCallExpr();
            case JavaPackage.METHOD_REFERENCE_EXPR: return createMethodReferenceExpr();
            case JavaPackage.NAME: return createName();
            case JavaPackage.NAME_EXPR: return createNameExpr();
            case JavaPackage.NORMAL_ANNOTATION_EXPR: return createNormalAnnotationExpr();
            case JavaPackage.NULL_LITERAL_EXPR: return createNullLiteralExpr();
            case JavaPackage.OBJECT_CREATION_EXPR: return createObjectCreationExpr();
            case JavaPackage.PATTERN_EXPR: return createPatternExpr();
            case JavaPackage.SIMPLE_NAME: return createSimpleName();
            case JavaPackage.SINGLE_MEMBER_ANNOTATION_EXPR: return createSingleMemberAnnotationExpr();
            case JavaPackage.STRING_LITERAL_EXPR: return createStringLiteralExpr();
            case JavaPackage.SUPER_EXPR: return createSuperExpr();
            case JavaPackage.SWITCH_EXPR: return createSwitchExpr();
            case JavaPackage.TEXT_BLOCK_LITERAL_EXPR: return createTextBlockLiteralExpr();
            case JavaPackage.THIS_EXPR: return createThisExpr();
            case JavaPackage.TYPE_EXPR: return createTypeExpr();
            case JavaPackage.UNARY_EXPR: return createUnaryExpr();
            case JavaPackage.VARIABLE_DECLARATION_EXPR: return createVariableDeclarationExpr();
            case JavaPackage.MODULE_DECLARATION: return createModuleDeclaration();
            case JavaPackage.MODULE_EXPORTS_DIRECTIVE: return createModuleExportsDirective();
            case JavaPackage.MODULE_OPENS_DIRECTIVE: return createModuleOpensDirective();
            case JavaPackage.MODULE_PROVIDES_DIRECTIVE: return createModuleProvidesDirective();
            case JavaPackage.MODULE_REQUIRES_DIRECTIVE: return createModuleRequiresDirective();
            case JavaPackage.MODULE_USES_DIRECTIVE: return createModuleUsesDirective();
            case JavaPackage.ASSERT_STMT: return createAssertStmt();
            case JavaPackage.BLOCK_STMT: return createBlockStmt();
            case JavaPackage.BREAK_STMT: return createBreakStmt();
            case JavaPackage.CATCH_CLAUSE: return createCatchClause();
            case JavaPackage.CONTINUE_STMT: return createContinueStmt();
            case JavaPackage.DO_STMT: return createDoStmt();
            case JavaPackage.EMPTY_STMT: return createEmptyStmt();
            case JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT: return createExplicitConstructorInvocationStmt();
            case JavaPackage.EXPRESSION_STMT: return createExpressionStmt();
            case JavaPackage.FOR_EACH_STMT: return createForEachStmt();
            case JavaPackage.FOR_STMT: return createForStmt();
            case JavaPackage.IF_STMT: return createIfStmt();
            case JavaPackage.LABELED_STMT: return createLabeledStmt();
            case JavaPackage.LOCAL_CLASS_DECLARATION_STMT: return createLocalClassDeclarationStmt();
            case JavaPackage.RETURN_STMT: return createReturnStmt();
            case JavaPackage.STATEMENT: return createStatement();
            case JavaPackage.SWITCH_ENTRY: return createSwitchEntry();
            case JavaPackage.SWITCH_STMT: return createSwitchStmt();
            case JavaPackage.SYNCHRONIZED_STMT: return createSynchronizedStmt();
            case JavaPackage.THROW_STMT: return createThrowStmt();
            case JavaPackage.TRY_STMT: return createTryStmt();
            case JavaPackage.WHILE_STMT: return createWhileStmt();
            case JavaPackage.YIELD_STMT: return createYieldStmt();
            case JavaPackage.ARRAY_TYPE: return createArrayType();
            case JavaPackage.CLASS_OR_INTERFACE_TYPE: return createClassOrInterfaceType();
            ...
            case JavaPackage.UNKNOWN_TYPE: return createUnknownType();
            case JavaPackage.VAR_TYPE: return createVarType();
            case JavaPackage.VOID_TYPE: return createVoidType();
            case JavaPackage.WILDCARD_TYPE: return createWildcardType();
            default:
