...
public class WildcardTypeImpl extends TypeImpl implements WildcardType {
    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    JavaPackage.WILDCARD_TYPE__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public NotificationChain basicSetExtendedType( ReferenceType newExtendedType, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.WILDCARD_TYPE__EXTENDED_TYPE, oldExtendedType, newExtendedType );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newExtendedType != extendedType ) {
            ...
            if( extendedType != null )
                msgs = ( ( InternalEObject ) extendedType ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.WILDCARD_TYPE__EXTENDED_TYPE, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.WILDCARD_TYPE__EXTENDED_TYPE,
    ...
    public NotificationChain basicSetSuperType( ReferenceType newSuperType, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.WILDCARD_TYPE__SUPER_TYPE, oldSuperType, newSuperType );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newSuperType != superType ) {
            ...
            if( superType != null )
                msgs = ( ( InternalEObject ) superType ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.WILDCARD_TYPE__SUPER_TYPE, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.WILDCARD_TYPE__SUPER_TYPE, newSuperType,
                    newSuperType ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case JavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return JavaPackage.WILDCARD_TYPE__ANNOTATIONS;
            default:
                return -1;
            }
        }
