 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.LocalClassDeclarationStmtImpl#getClassDeclaration <em>Class Declaration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocalClassDeclarationStmtImpl extends StatementImpl implements LocalClassDeclarationStmt {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.LOCAL_CLASS_DECLARATION_STMT;
    }
    ...
    public NotificationChain basicSetClassDeclaration( ClassOrInterfaceDeclaration newClassDeclaration,
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.LOCAL_CLASS_DECLARATION_STMT__CLASS_DECLARATION, oldClassDeclaration,
                    newClassDeclaration );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newClassDeclaration != classDeclaration ) {
            ...
            if( classDeclaration != null )
                msgs = ( ( InternalEObject ) classDeclaration ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.LOCAL_CLASS_DECLARATION_STMT__CLASS_DECLARATION, null,
                        msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.LOCAL_CLASS_DECLARATION_STMT__CLASS_DECLARATION, newClassDeclaration,
                    newClassDeclaration ) );
    }
