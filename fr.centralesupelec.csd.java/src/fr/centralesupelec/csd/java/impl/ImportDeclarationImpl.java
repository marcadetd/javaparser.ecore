...
public class ImportDeclarationImpl extends JavaNodeImpl implements ImportDeclaration {
    ...
    public NotificationChain basicSetName( Name newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.IMPORT_DECLARATION__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.IMPORT_DECLARATION__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.IMPORT_DECLARATION__NAME, newName,
                    newName ) );
    }
    ...
    public void setStatic( boolean newStatic ) {
        ...
        static_ = newStatic;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.IMPORT_DECLARATION__STATIC, oldStatic,
                    static_ ) );
    }
    ...
    public void setAsterisk( boolean newAsterisk ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.IMPORT_DECLARATION__ASTERISK,
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithName.class ) {
            ...
            case JavaPackage.NODE_WITH_NAME__NAME:
                return JavaPackage.IMPORT_DECLARATION__NAME;
            default:
                return -1;
            }
        }
