...
public class ExplicitConstructorInvocationStmtImpl extends StatementImpl implements ExplicitConstructorInvocationStmt {
    ...
    public EList< Type > getTypeArguments() {
        if( typeArguments == null ) {
            typeArguments = new EObjectContainmentEList< Type >( Type.class, this,
                    JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__TYPE_ARGUMENTS );
        }
    ...
    public EList< Expression > getArguments() {
        if( arguments == null ) {
            arguments = new EObjectContainmentEList< Expression >( Expression.class, this,
                    JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__ARGUMENTS );
        }
        return arguments;
    }
    ...
    public NotificationChain basicSetExpression( Expression newExpression, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__EXPRESSION, oldExpression, newExpression );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newExpression != expression ) {
            ...
            if( expression != null )
                msgs = ( ( InternalEObject ) expression ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__EXPRESSION, null,
                        msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET,
                    JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__EXPRESSION, newExpression, newExpression ) );
    }
    ...
    public void setIsThis( boolean newIsThis ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET,
                    JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__IS_THIS, oldIsThis, isThis ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithTypeArguments.class ) {
            ...
            case JavaPackage.NODE_WITH_TYPE_ARGUMENTS__TYPE_ARGUMENTS:
                return JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__TYPE_ARGUMENTS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithArguments.class ) {
            ...
            case JavaPackage.NODE_WITH_ARGUMENTS__ARGUMENTS:
                return JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__ARGUMENTS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithExpression.class ) {
            ...
            case JavaPackage.NODE_WITH_EXPRESSION__EXPRESSION:
                return JavaPackage.EXPLICIT_CONSTRUCTOR_INVOCATION_STMT__EXPRESSION;
            default:
                return -1;
            }
        }
