...
public class ArrayCreationExprImpl extends ExpressionImpl implements ArrayCreationExpr {
	...
	public EList<ArrayCreationLevel> getLevels() {
        if (levels == null) {
            levels = new EObjectContainmentEList<ArrayCreationLevel>(ArrayCreationLevel.class, this, JavaPackage.ARRAY_CREATION_EXPR__LEVELS);
        }
        return levels;
    }
        ...
        if (elementType != null && elementType.eIsProxy()) {
            ...
            if (elementType != oldElementType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, JavaPackage.ARRAY_CREATION_EXPR__ELEMENT_TYPE, oldElementType, elementType));
            }
        }
        return elementType;
    }
	...
	public void setElementType(Type newElementType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.ARRAY_CREATION_EXPR__ELEMENT_TYPE, oldElementType, elementType));
    }
	...
	public NotificationChain basicSetInitializer(ArrayInitializerExpr newInitializer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.ARRAY_CREATION_EXPR__INITIALIZER, oldInitializer, newInitializer);
	...
	public void setInitializer(ArrayInitializerExpr newInitializer) {
        if (newInitializer != initializer) {
            ...
            if (initializer != null)
                msgs = ((InternalEObject)initializer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ARRAY_CREATION_EXPR__INITIALIZER, null, msgs);
            if (newInitializer != null)
                msgs = ((InternalEObject)newInitializer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ARRAY_CREATION_EXPR__INITIALIZER, null, msgs);
            msgs = basicSetInitializer(newInitializer, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.ARRAY_CREATION_EXPR__INITIALIZER, newInitializer, newInitializer));
    }
