...
public class BreakStmtImpl extends StatementImpl implements BreakStmt {
	...
	public NotificationChain basicSetLabel(SimpleName newLabel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.BREAK_STMT__LABEL, oldLabel, newLabel);
	...
	public void setLabel(SimpleName newLabel) {
        if (newLabel != label) {
            ...
            if (label != null)
                msgs = ((InternalEObject)label).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.BREAK_STMT__LABEL, null, msgs);
            if (newLabel != null)
                msgs = ((InternalEObject)newLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.BREAK_STMT__LABEL, null, msgs);
            msgs = basicSetLabel(newLabel, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.BREAK_STMT__LABEL, newLabel, newLabel));
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithLabel.class) {
            switch (derivedFeatureID) {
                case JavaPackage.BREAK_STMT__LABEL: return JavaPackage.NODE_WITH_LABEL__LABEL;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithLabel.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_LABEL__LABEL: return JavaPackage.BREAK_STMT__LABEL;
                default: return -1;
            }
        }
