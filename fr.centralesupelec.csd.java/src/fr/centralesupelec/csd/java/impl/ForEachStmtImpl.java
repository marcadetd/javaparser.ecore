...
public class ForEachStmtImpl extends StatementImpl implements ForEachStmt {
	...
	public NotificationChain basicSetBody(Statement newBody, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.FOR_EACH_STMT__BODY, oldBody, newBody);
	...
	public void setBody(Statement newBody) {
        if (newBody != body) {
            ...
            if (body != null)
                msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FOR_EACH_STMT__BODY, null, msgs);
            if (newBody != null)
                msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FOR_EACH_STMT__BODY, null, msgs);
            msgs = basicSetBody(newBody, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.FOR_EACH_STMT__BODY, newBody, newBody));
    }
	...
	public NotificationChain basicSetVariable(VariableDeclarationExpr newVariable, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.FOR_EACH_STMT__VARIABLE, oldVariable, newVariable);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
	...
	public void setVariable(VariableDeclarationExpr newVariable) {
        if (newVariable != variable) {
            NotificationChain msgs = null;
            if (variable != null)
                msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FOR_EACH_STMT__VARIABLE, null, msgs);
            if (newVariable != null)
                msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FOR_EACH_STMT__VARIABLE, null, msgs);
            msgs = basicSetVariable(newVariable, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.FOR_EACH_STMT__VARIABLE, newVariable, newVariable));
    }
	...
	public NotificationChain basicSetIterable(Expression newIterable, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.FOR_EACH_STMT__ITERABLE, oldIterable, newIterable);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
	...
	public void setIterable(Expression newIterable) {
        if (newIterable != iterable) {
            NotificationChain msgs = null;
            if (iterable != null)
                msgs = ((InternalEObject)iterable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FOR_EACH_STMT__ITERABLE, null, msgs);
            if (newIterable != null)
                msgs = ((InternalEObject)newIterable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.FOR_EACH_STMT__ITERABLE, null, msgs);
            msgs = basicSetIterable(newIterable, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.FOR_EACH_STMT__ITERABLE, newIterable, newIterable));
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithBody.class) {
            switch (derivedFeatureID) {
                case JavaPackage.FOR_EACH_STMT__BODY: return JavaPackage.NODE_WITH_BODY__BODY;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithBody.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_BODY__BODY: return JavaPackage.FOR_EACH_STMT__BODY;
                default: return -1;
            }
        }
