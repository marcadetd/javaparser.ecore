 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ModuleUsesDirectiveImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleUsesDirectiveImpl extends ModuleDirectiveImpl implements ModuleUsesDirective {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.MODULE_USES_DIRECTIVE;
    }
    ...
    public NotificationChain basicSetName( Name newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.MODULE_USES_DIRECTIVE__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.MODULE_USES_DIRECTIVE__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.MODULE_USES_DIRECTIVE__NAME, newName,
                    newName ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithName.class ) {
            ...
            case EJavaPackage.NODE_WITH_NAME__NAME:
                return EJavaPackage.MODULE_USES_DIRECTIVE__NAME;
            default:
                return -1;
            }
        }
