...
public class ClassOrInterfaceDeclarationImpl extends TypeDeclarationImpl implements ClassOrInterfaceDeclaration {
	...
	public void setInterface(boolean newInterface) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.CLASS_OR_INTERFACE_DECLARATION__INTERFACE, oldInterface, interface_));
    }
	...
	public EList<TypeParameter> getTypeParameters() {
        if (typeParameters == null) {
            typeParameters = new EObjectContainmentEList<TypeParameter>(TypeParameter.class, this, JavaPackage.CLASS_OR_INTERFACE_DECLARATION__TYPE_PARAMETERS);
        }
...
//        throw new UnsupportedOperationException();
	...
	public EList<ClassOrInterfaceType> getExtendedTypes() {
        if (extendedTypes == null) {
            extendedTypes = new EObjectContainmentEList<ClassOrInterfaceType>(ClassOrInterfaceType.class, this, JavaPackage.CLASS_OR_INTERFACE_DECLARATION__EXTENDED_TYPES);
        }
	...
	public EList<ClassOrInterfaceType> getImplementedTypes() {
        if (implementedTypes == null) {
            implementedTypes = new EObjectContainmentEList<ClassOrInterfaceType>(ClassOrInterfaceType.class, this, JavaPackage.CLASS_OR_INTERFACE_DECLARATION__IMPLEMENTED_TYPES);
        }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithImplements.class) {
            switch (derivedFeatureID) {
                case JavaPackage.CLASS_OR_INTERFACE_DECLARATION__IMPLEMENTED_TYPES: return JavaPackage.NODE_WITH_IMPLEMENTS__IMPLEMENTED_TYPES;
                default: return -1;
            }
        }
        if (baseClass == NodeWithExtends.class) {
            switch (derivedFeatureID) {
                case JavaPackage.CLASS_OR_INTERFACE_DECLARATION__EXTENDED_TYPES: return JavaPackage.NODE_WITH_EXTENDS__EXTENDED_TYPES;
                default: return -1;
            }
        }
        if (baseClass == NodeWithTypeParameters.class) {
            switch (derivedFeatureID) {
                case JavaPackage.CLASS_OR_INTERFACE_DECLARATION__TYPE_PARAMETERS: return JavaPackage.NODE_WITH_TYPE_PARAMETERS__TYPE_PARAMETERS;
                default: return -1;
            }
        }
        if (baseClass == NodeWithAbstractModifier.class) {
            switch (derivedFeatureID) {
                case JavaPackage.CLASS_OR_INTERFACE_DECLARATION__ABSTRACT: return JavaPackage.NODE_WITH_ABSTRACT_MODIFIER__ABSTRACT;
                default: return -1;
            }
        }
        if (baseClass == NodeWithFinalModifier.class) {
            switch (derivedFeatureID) {
                case JavaPackage.CLASS_OR_INTERFACE_DECLARATION__FINAL: return JavaPackage.NODE_WITH_FINAL_MODIFIER__FINAL;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == NodeWithImplements.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_IMPLEMENTS__IMPLEMENTED_TYPES: return JavaPackage.CLASS_OR_INTERFACE_DECLARATION__IMPLEMENTED_TYPES;
                default: return -1;
            }
        }
        if (baseClass == NodeWithExtends.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_EXTENDS__EXTENDED_TYPES: return JavaPackage.CLASS_OR_INTERFACE_DECLARATION__EXTENDED_TYPES;
                default: return -1;
            }
        }
        if (baseClass == NodeWithTypeParameters.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_TYPE_PARAMETERS__TYPE_PARAMETERS: return JavaPackage.CLASS_OR_INTERFACE_DECLARATION__TYPE_PARAMETERS;
                default: return -1;
            }
        }
        if (baseClass == NodeWithAbstractModifier.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_ABSTRACT_MODIFIER__ABSTRACT: return JavaPackage.CLASS_OR_INTERFACE_DECLARATION__ABSTRACT;
                default: return -1;
            }
        }
        if (baseClass == NodeWithFinalModifier.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_FINAL_MODIFIER__FINAL: return JavaPackage.CLASS_OR_INTERFACE_DECLARATION__FINAL;
                default: return -1;
            }
        }
