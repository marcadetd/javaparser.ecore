 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ModuleDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ModuleDeclarationImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ModuleDeclarationImpl#isOpen <em>Open</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ModuleDeclarationImpl#getDirectives <em>Directives</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleDeclarationImpl extends JavaNodeImpl implements ModuleDeclaration {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.MODULE_DECLARATION;
    }
    ...
    public NotificationChain basicSetName( Name newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.MODULE_DECLARATION__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.MODULE_DECLARATION__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.MODULE_DECLARATION__NAME, newName,
                    newName ) );
    }
    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    EJavaPackage.MODULE_DECLARATION__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public void setOpen( boolean newOpen ) {
        ...
        open = newOpen;
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.MODULE_DECLARATION__OPEN, oldOpen,
                    open ) );
    }
    ...
    public EList< ModuleDirective > getDirectives() {
        if( directives == null ) {
            directives = new EObjectContainmentEList< ModuleDirective >( ModuleDirective.class, this,
                    EJavaPackage.MODULE_DECLARATION__DIRECTIVES );
        }
        return directives;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithName.class ) {
            ...
            case EJavaPackage.NODE_WITH_NAME__NAME:
                return EJavaPackage.MODULE_DECLARATION__NAME;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case EJavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return EJavaPackage.MODULE_DECLARATION__ANNOTATIONS;
            default:
                return -1;
            }
        }
