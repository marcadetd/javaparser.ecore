 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ThisExprImpl#getTypeName <em>Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThisExprImpl extends ExpressionImpl implements ThisExpr {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.THIS_EXPR;
    }
    ...
    public NotificationChain basicSetTypeName( Name newTypeName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.THIS_EXPR__TYPE_NAME, oldTypeName, newTypeName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newTypeName != typeName ) {
            ...
            if( typeName != null )
                msgs = ( ( InternalEObject ) typeName ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.THIS_EXPR__TYPE_NAME, null, msgs );
            if( newTypeName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.THIS_EXPR__TYPE_NAME, newTypeName,
                    newTypeName ) );
    }
    ...
    public NotificationChain eInverseRemove( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case EJavaPackage.THIS_EXPR__TYPE_NAME:
