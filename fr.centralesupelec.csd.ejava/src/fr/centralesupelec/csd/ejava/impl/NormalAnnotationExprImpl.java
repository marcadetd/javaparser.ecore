 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.NormalAnnotationExprImpl#getPairs <em>Pairs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NormalAnnotationExprImpl extends AnnotationExprImpl implements NormalAnnotationExpr {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.NORMAL_ANNOTATION_EXPR;
    }
    ...
    public EList< MemberValuePair > getPairs() {
        if( pairs == null ) {
            pairs = new EObjectContainmentEList< MemberValuePair >( MemberValuePair.class, this,
                    EJavaPackage.NORMAL_ANNOTATION_EXPR__PAIRS );
        }
        return pairs;
    }
