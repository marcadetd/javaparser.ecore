 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.SwitchStmtImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.SwitchStmtImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchStmtImpl extends StatementImpl implements SwitchStmt {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.SWITCH_STMT;
    }
    ...
    public NotificationChain basicSetSelector( Expression newSelector, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.SWITCH_STMT__SELECTOR, oldSelector, newSelector );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newSelector != selector ) {
            ...
            if( selector != null )
                msgs = ( ( InternalEObject ) selector ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.SWITCH_STMT__SELECTOR, null, msgs );
            if( newSelector != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.SWITCH_STMT__SELECTOR, newSelector,
                    newSelector ) );
    }
    ...
    public EList< SwitchEntry > getEntries() {
        if( entries == null ) {
            entries = new EObjectContainmentEList< SwitchEntry >( SwitchEntry.class, this,
                    EJavaPackage.SWITCH_STMT__ENTRIES );
        }
        return entries;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == SwitchNode.class ) {
            ...
            case EJavaPackage.SWITCH_NODE__SELECTOR:
                return EJavaPackage.SWITCH_STMT__SELECTOR;
            case EJavaPackage.SWITCH_NODE__ENTRIES:
                return EJavaPackage.SWITCH_STMT__ENTRIES;
            default:
                return -1;
            }
        }
