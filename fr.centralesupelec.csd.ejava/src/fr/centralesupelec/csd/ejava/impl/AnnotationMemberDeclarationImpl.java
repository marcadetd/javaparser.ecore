 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.AnnotationMemberDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.AnnotationMemberDeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.AnnotationMemberDeclarationImpl#getModifiers <em>Modifiers</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.AnnotationMemberDeclarationImpl#isPublic <em>Public</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.AnnotationMemberDeclarationImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.AnnotationMemberDeclarationImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationMemberDeclarationImpl extends BodyDeclarationImpl implements AnnotationMemberDeclaration {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.ANNOTATION_MEMBER_DECLARATION;
    }
    ...
    public NotificationChain basicSetName( SimpleName newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.ANNOTATION_MEMBER_DECLARATION__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.ANNOTATION_MEMBER_DECLARATION__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.ANNOTATION_MEMBER_DECLARATION__NAME,
                    newName, newName ) );
    }
    ...
    public NotificationChain basicSetType( Type newType, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.ANNOTATION_MEMBER_DECLARATION__TYPE, oldType, newType );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newType != type ) {
            ...
            if( type != null )
                msgs = ( ( InternalEObject ) type ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.ANNOTATION_MEMBER_DECLARATION__TYPE, null, msgs );
            if( newType != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.ANNOTATION_MEMBER_DECLARATION__TYPE,
                    newType, newType ) );
    }
    ...
    public EList< ModifierKeyword > getModifiers() {
        if( modifiers == null ) {
            modifiers = new EDataTypeUniqueEList< ModifierKeyword >( ModifierKeyword.class, this,
                    EJavaPackage.ANNOTATION_MEMBER_DECLARATION__MODIFIERS );
        }
        return modifiers;
    }
    ...
    public NotificationChain basicSetDefaultValue( Expression newDefaultValue, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.ANNOTATION_MEMBER_DECLARATION__DEFAULT_VALUE, oldDefaultValue, newDefaultValue );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newDefaultValue != defaultValue ) {
            ...
            if( defaultValue != null )
                msgs = ( ( InternalEObject ) defaultValue ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.ANNOTATION_MEMBER_DECLARATION__DEFAULT_VALUE, null,
                        msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.ANNOTATION_MEMBER_DECLARATION__DEFAULT_VALUE, newDefaultValue, newDefaultValue ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        ...
        if( baseClass == NodeWithSimpleName.class ) {
            ...
            case EJavaPackage.NODE_WITH_SIMPLE_NAME__NAME:
                return EJavaPackage.ANNOTATION_MEMBER_DECLARATION__NAME;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithType.class ) {
            ...
            case EJavaPackage.NODE_WITH_TYPE__TYPE:
                return EJavaPackage.ANNOTATION_MEMBER_DECLARATION__TYPE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithModifiers.class ) {
            ...
            case EJavaPackage.NODE_WITH_MODIFIERS__MODIFIERS:
                return EJavaPackage.ANNOTATION_MEMBER_DECLARATION__MODIFIERS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithPublicModifier.class ) {
            ...
            case EJavaPackage.NODE_WITH_PUBLIC_MODIFIER__PUBLIC:
                return EJavaPackage.ANNOTATION_MEMBER_DECLARATION__PUBLIC;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithAbstractModifier.class ) {
            ...
            case EJavaPackage.NODE_WITH_ABSTRACT_MODIFIER__ABSTRACT:
                return EJavaPackage.ANNOTATION_MEMBER_DECLARATION__ABSTRACT;
            default:
                return -1;
            }
        }
