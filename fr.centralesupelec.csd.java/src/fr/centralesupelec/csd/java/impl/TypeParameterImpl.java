    ...
    public NotificationChain basicSetName( SimpleName newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.TYPE_PARAMETER__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.TYPE_PARAMETER__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.TYPE_PARAMETER__NAME, newName,
                    newName ) );
    }
    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    JavaPackage.TYPE_PARAMETER__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public EList< ClassOrInterfaceType > getTypeBound() {
        if( typeBound == null ) {
            typeBound = new EObjectContainmentEList< ClassOrInterfaceType >( ClassOrInterfaceType.class, this,
                    JavaPackage.TYPE_PARAMETER__TYPE_BOUND );
        }
        return typeBound;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithSimpleName.class ) {
            ...
            case JavaPackage.NODE_WITH_SIMPLE_NAME__NAME:
                return JavaPackage.TYPE_PARAMETER__NAME;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case JavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return JavaPackage.TYPE_PARAMETER__ANNOTATIONS;
            default:
                return -1;
            }
        }
