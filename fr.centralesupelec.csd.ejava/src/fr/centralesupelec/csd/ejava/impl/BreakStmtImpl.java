 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.BreakStmtImpl#getLabel <em>Label</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BreakStmtImpl extends StatementImpl implements BreakStmt {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.BREAK_STMT;
    }
    ...
    public NotificationChain basicSetLabel( SimpleName newLabel, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.BREAK_STMT__LABEL, oldLabel, newLabel );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newLabel != label ) {
            ...
            if( label != null )
                msgs = ( ( InternalEObject ) label ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.BREAK_STMT__LABEL, null, msgs );
            if( newLabel != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.BREAK_STMT__LABEL, newLabel,
                    newLabel ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithLabel.class ) {
            ...
            case EJavaPackage.NODE_WITH_LABEL__LABEL:
                return EJavaPackage.BREAK_STMT__LABEL;
            default:
                return -1;
            }
        }
