...
public class SynchronizedStmtImpl extends StatementImpl implements SynchronizedStmt {
    ...
    public NotificationChain basicSetBody( BlockStmt newBody, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.SYNCHRONIZED_STMT__BODY, oldBody, newBody );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newBody != body ) {
            ...
            if( body != null )
                msgs = ( ( InternalEObject ) body ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.SYNCHRONIZED_STMT__BODY, null, msgs );
            if( newBody != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.SYNCHRONIZED_STMT__BODY, newBody,
                    newBody ) );
    }
    ...
    public NotificationChain basicSetExpression( Expression newExpression, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.SYNCHRONIZED_STMT__EXPRESSION, oldExpression, newExpression );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newExpression != expression ) {
            ...
            if( expression != null )
                msgs = ( ( InternalEObject ) expression ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.SYNCHRONIZED_STMT__EXPRESSION, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.SYNCHRONIZED_STMT__EXPRESSION,
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithBlockStmt.class ) {
            ...
            case JavaPackage.NODE_WITH_BLOCK_STMT__BODY:
                return JavaPackage.SYNCHRONIZED_STMT__BODY;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithExpression.class ) {
            ...
            case JavaPackage.NODE_WITH_EXPRESSION__EXPRESSION:
                return JavaPackage.SYNCHRONIZED_STMT__EXPRESSION;
            default:
                return -1;
            }
        }
