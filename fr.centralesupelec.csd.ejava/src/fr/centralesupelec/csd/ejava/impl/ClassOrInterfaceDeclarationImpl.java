 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ClassOrInterfaceDeclarationImpl#getImplementedTypes <em>Implemented Types</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ClassOrInterfaceDeclarationImpl#getExtendedTypes <em>Extended Types</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ClassOrInterfaceDeclarationImpl#getTypeParameters <em>Type Parameters</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ClassOrInterfaceDeclarationImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ClassOrInterfaceDeclarationImpl#isFinal <em>Final</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ClassOrInterfaceDeclarationImpl#isInterface <em>Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassOrInterfaceDeclarationImpl extends TypeDeclarationImpl implements ClassOrInterfaceDeclaration {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.CLASS_OR_INTERFACE_DECLARATION;
    }
    ...
    public EList< ClassOrInterfaceType > getImplementedTypes() {
        if( implementedTypes == null ) {
            implementedTypes = new EObjectContainmentEList< ClassOrInterfaceType >( ClassOrInterfaceType.class, this,
                    EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__IMPLEMENTED_TYPES );
        }
    ...
    public EList< ClassOrInterfaceType > getExtendedTypes() {
        if( extendedTypes == null ) {
            extendedTypes = new EObjectContainmentEList< ClassOrInterfaceType >( ClassOrInterfaceType.class, this,
                    EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__EXTENDED_TYPES );
        }
    ...
    public EList< TypeParameter > getTypeParameters() {
        if( typeParameters == null ) {
            typeParameters = new EObjectContainmentEList< TypeParameter >( TypeParameter.class, this,
                    EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__TYPE_PARAMETERS );
        }
    ...
    public void setInterface( boolean newInterface ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__INTERFACE, oldInterface, interface_ ) );
    }
    ...
    public int eBaseStructuralFeatureID( int derivedFeatureID, Class< ? > baseClass ) {
        ...
        if( baseClass == NodeWithExtends.class ) {
            switch( derivedFeatureID ) {
            case EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__EXTENDED_TYPES:
                return EJavaPackage.NODE_WITH_EXTENDS__EXTENDED_TYPES;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithImplements.class ) {
            ...
            case EJavaPackage.NODE_WITH_IMPLEMENTS__IMPLEMENTED_TYPES:
                return EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__IMPLEMENTED_TYPES;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithExtends.class ) {
            switch( baseFeatureID ) {
            case EJavaPackage.NODE_WITH_EXTENDS__EXTENDED_TYPES:
                return EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__EXTENDED_TYPES;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithTypeParameters.class ) {
            ...
            case EJavaPackage.NODE_WITH_TYPE_PARAMETERS__TYPE_PARAMETERS:
                return EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__TYPE_PARAMETERS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithAbstractModifier.class ) {
            ...
            case EJavaPackage.NODE_WITH_ABSTRACT_MODIFIER__ABSTRACT:
                return EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__ABSTRACT;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithFinalModifier.class ) {
            ...
            case EJavaPackage.NODE_WITH_FINAL_MODIFIER__FINAL:
                return EJavaPackage.CLASS_OR_INTERFACE_DECLARATION__FINAL;
            default:
                return -1;
            }
        }
