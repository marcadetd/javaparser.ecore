    ...
    public EList< AnnotationExpr > getAnnotations() {
        if( annotations == null ) {
            annotations = new EObjectContainmentEList< AnnotationExpr >( AnnotationExpr.class, this,
                    JavaPackage.ARRAY_CREATION_LEVEL__ANNOTATIONS );
        }
        return annotations;
    }
    ...
    public NotificationChain basicSetDimension( Expression newDimension, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.ARRAY_CREATION_LEVEL__DIMENSION, oldDimension, newDimension );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newDimension != dimension ) {
            ...
            if( dimension != null )
                msgs = ( ( InternalEObject ) dimension ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.ARRAY_CREATION_LEVEL__DIMENSION, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.ARRAY_CREATION_LEVEL__DIMENSION,
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithAnnotations.class ) {
            ...
            case JavaPackage.NODE_WITH_ANNOTATIONS__ANNOTATIONS:
                return JavaPackage.ARRAY_CREATION_LEVEL__ANNOTATIONS;
            default:
                return -1;
            }
        }
