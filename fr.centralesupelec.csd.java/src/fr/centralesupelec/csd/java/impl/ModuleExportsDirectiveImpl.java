    ...
    public NotificationChain basicSetName( Name newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.MODULE_EXPORTS_DIRECTIVE__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.MODULE_EXPORTS_DIRECTIVE__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.MODULE_EXPORTS_DIRECTIVE__NAME, newName,
                    newName ) );
    }
    ...
    public EList< Name > getModuleNames() {
        if( moduleNames == null ) {
            moduleNames = new EObjectContainmentEList< Name >( Name.class, this,
                    JavaPackage.MODULE_EXPORTS_DIRECTIVE__MODULE_NAMES );
        }
        return moduleNames;
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithName.class ) {
            ...
            case JavaPackage.NODE_WITH_NAME__NAME:
                return JavaPackage.MODULE_EXPORTS_DIRECTIVE__NAME;
            default:
                return -1;
            }
        }
