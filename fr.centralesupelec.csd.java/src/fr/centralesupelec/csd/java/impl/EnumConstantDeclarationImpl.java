...
public class EnumConstantDeclarationImpl extends BodyDeclarationImpl implements EnumConstantDeclaration {
	...
	public NotificationChain basicSetName(SimpleName newName, NotificationChain msgs) {
        ...
        name = newName;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.ENUM_CONSTANT_DECLARATION__NAME, oldName, newName);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
	...
	public void setName(SimpleName newName) {
        if (newName != name) {
            NotificationChain msgs = null;
            if (name != null)
                msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ENUM_CONSTANT_DECLARATION__NAME, null, msgs);
            if (newName != null)
                msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ENUM_CONSTANT_DECLARATION__NAME, null, msgs);
            msgs = basicSetName(newName, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.ENUM_CONSTANT_DECLARATION__NAME, newName, newName));
    }
	...
	public EList<BodyDeclaration> getClassBody() {
        if (classBody == null) {
            classBody = new EObjectContainmentEList<BodyDeclaration>(BodyDeclaration.class, this, JavaPackage.ENUM_CONSTANT_DECLARATION__CLASS_BODY);
        }
        return classBody;
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == NodeWithSimpleName.class) {
            switch (derivedFeatureID) {
                case JavaPackage.ENUM_CONSTANT_DECLARATION__NAME: return JavaPackage.NODE_WITH_SIMPLE_NAME__NAME;
                default: return -1;
            }
        }
        if (baseClass == NodeWithArguments.class) {
            switch (derivedFeatureID) {
                case JavaPackage.ENUM_CONSTANT_DECLARATION__ARGUMENTS: return JavaPackage.NODE_WITH_ARGUMENTS__ARGUMENTS;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == NodeWithSimpleName.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_SIMPLE_NAME__NAME: return JavaPackage.ENUM_CONSTANT_DECLARATION__NAME;
                default: return -1;
            }
        }
        if (baseClass == NodeWithArguments.class) {
            switch (baseFeatureID) {
                case JavaPackage.NODE_WITH_ARGUMENTS__ARGUMENTS: return JavaPackage.ENUM_CONSTANT_DECLARATION__ARGUMENTS;
                default: return -1;
            }
        }
