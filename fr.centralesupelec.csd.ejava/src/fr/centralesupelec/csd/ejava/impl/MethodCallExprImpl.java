 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.MethodCallExprImpl#getTypeArguments <em>Type Arguments</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.MethodCallExprImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.MethodCallExprImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.MethodCallExprImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodCallExprImpl extends ExpressionImpl implements MethodCallExpr {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.METHOD_CALL_EXPR;
    }
    ...
    public EList< Type > getTypeArguments() {
        if( typeArguments == null ) {
            typeArguments = new EObjectContainmentEList< Type >( Type.class, this,
                    EJavaPackage.METHOD_CALL_EXPR__TYPE_ARGUMENTS );
        }
    ...
    public EList< Expression > getArguments() {
        if( arguments == null ) {
            arguments = new EObjectContainmentEList< Expression >( Expression.class, this,
                    EJavaPackage.METHOD_CALL_EXPR__ARGUMENTS );
        }
        return arguments;
    }
    ...
    public NotificationChain basicSetName( SimpleName newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.METHOD_CALL_EXPR__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.METHOD_CALL_EXPR__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.METHOD_CALL_EXPR__NAME, newName,
                    newName ) );
    }
    ...
    public NotificationChain basicSetScope( Expression newScope, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.METHOD_CALL_EXPR__SCOPE, oldScope, newScope );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newScope != scope ) {
            ...
            if( scope != null )
                msgs = ( ( InternalEObject ) scope ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.METHOD_CALL_EXPR__SCOPE, null, msgs );
            if( newScope != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.METHOD_CALL_EXPR__SCOPE, newScope,
                    newScope ) );
    }
    ...
    public NotificationChain eInverseRemove( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case EJavaPackage.METHOD_CALL_EXPR__TYPE_ARGUMENTS:
            return ( ( InternalEList< ? > ) getTypeArguments() ).basicRemove( otherEnd, msgs );
        case EJavaPackage.METHOD_CALL_EXPR__ARGUMENTS:
            return ( ( InternalEList< ? > ) getArguments() ).basicRemove( otherEnd, msgs );
        case EJavaPackage.METHOD_CALL_EXPR__NAME:
            return basicSetName( null, msgs );
        case EJavaPackage.METHOD_CALL_EXPR__SCOPE:
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithTypeArguments.class ) {
            ...
            case EJavaPackage.NODE_WITH_TYPE_ARGUMENTS__TYPE_ARGUMENTS:
                return EJavaPackage.METHOD_CALL_EXPR__TYPE_ARGUMENTS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithArguments.class ) {
            ...
            case EJavaPackage.NODE_WITH_ARGUMENTS__ARGUMENTS:
                return EJavaPackage.METHOD_CALL_EXPR__ARGUMENTS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithSimpleName.class ) {
            ...
            case EJavaPackage.NODE_WITH_SIMPLE_NAME__NAME:
                return EJavaPackage.METHOD_CALL_EXPR__NAME;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithScope.class ) {
            ...
            case EJavaPackage.NODE_WITH_SCOPE__SCOPE:
                return EJavaPackage.METHOD_CALL_EXPR__SCOPE;
            default:
                return -1;
            }
        }
