...
public class SwitchEntryImpl extends JavaNodeImpl implements SwitchEntry {
    ...
    public EList< Statement > getStatements() {
        if( statements == null ) {
            statements = new EObjectContainmentEList< Statement >( Statement.class, this,
                    JavaPackage.SWITCH_ENTRY__STATEMENTS );
        }
        return statements;
    }
    ...
    public EList< Expression > getLabels() {
        if( labels == null ) {
            labels = new EObjectContainmentEList< Expression >( Expression.class, this,
                    JavaPackage.SWITCH_ENTRY__LABELS );
        }
        return labels;
    }
    ...
    public int eBaseStructuralFeatureID( int derivedFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithStatements.class ) {
            ...
            case JavaPackage.SWITCH_ENTRY__STATEMENTS:
                return JavaPackage.NODE_WITH_STATEMENTS__STATEMENTS;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithStatements.class ) {
            ...
            case JavaPackage.NODE_WITH_STATEMENTS__STATEMENTS:
                return JavaPackage.SWITCH_ENTRY__STATEMENTS;
            default:
                return -1;
            }
        }
