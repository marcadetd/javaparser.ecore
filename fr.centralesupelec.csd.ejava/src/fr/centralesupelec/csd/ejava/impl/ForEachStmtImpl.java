 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ForEachStmtImpl#getBody <em>Body</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ForEachStmtImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.ForEachStmtImpl#getIterable <em>Iterable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForEachStmtImpl extends StatementImpl implements ForEachStmt {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.FOR_EACH_STMT;
    }
    ...
    public NotificationChain basicSetBody( Statement newBody, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.FOR_EACH_STMT__BODY, oldBody, newBody );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newBody != body ) {
            ...
            if( body != null )
                msgs = ( ( InternalEObject ) body ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.FOR_EACH_STMT__BODY, null, msgs );
            if( newBody != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.FOR_EACH_STMT__BODY, newBody,
                    newBody ) );
    }
    ...
    public NotificationChain basicSetVariable( VariableDeclarationExpr newVariable, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.FOR_EACH_STMT__VARIABLE, oldVariable, newVariable );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newVariable != variable ) {
            ...
            if( variable != null )
                msgs = ( ( InternalEObject ) variable ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.FOR_EACH_STMT__VARIABLE, null, msgs );
            if( newVariable != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.FOR_EACH_STMT__VARIABLE, newVariable,
                    newVariable ) );
    }
    ...
    public NotificationChain basicSetIterable( Expression newIterable, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.FOR_EACH_STMT__ITERABLE, oldIterable, newIterable );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newIterable != iterable ) {
            ...
            if( iterable != null )
                msgs = ( ( InternalEObject ) iterable ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.FOR_EACH_STMT__ITERABLE, null, msgs );
            if( newIterable != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.FOR_EACH_STMT__ITERABLE, newIterable,
                    newIterable ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithBody.class ) {
            ...
            case EJavaPackage.NODE_WITH_BODY__BODY:
                return EJavaPackage.FOR_EACH_STMT__BODY;
            default:
                return -1;
            }
        }
