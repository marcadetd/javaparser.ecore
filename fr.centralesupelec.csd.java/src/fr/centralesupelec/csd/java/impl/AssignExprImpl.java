...
public class AssignExprImpl extends ExpressionImpl implements AssignExpr {
    ...
    public NotificationChain basicSetTarget( Expression newTarget, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.ASSIGN_EXPR__TARGET, oldTarget, newTarget );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newTarget != target ) {
            ...
            if( target != null )
                msgs = ( ( InternalEObject ) target ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.ASSIGN_EXPR__TARGET, null, msgs );
            if( newTarget != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.ASSIGN_EXPR__TARGET, newTarget,
                    newTarget ) );
    }
    ...
    public NotificationChain basicSetValue( Expression newValue, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.ASSIGN_EXPR__VALUE, oldValue, newValue );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newValue != value ) {
            ...
            if( value != null )
                msgs = ( ( InternalEObject ) value ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.ASSIGN_EXPR__VALUE, null, msgs );
            if( newValue != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.ASSIGN_EXPR__VALUE, newValue,
                    newValue ) );
    }
    ...
    public void setOperator( AssignOperator newOperator ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.ASSIGN_EXPR__OPERATOR, oldOperator,
                    operator ) );
    }
