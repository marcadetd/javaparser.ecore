...
public class LocalClassDeclarationStmtImpl extends StatementImpl implements LocalClassDeclarationStmt {
     ...
     * @generated
     */
	public NotificationChain basicSetClassDeclaration(ClassOrInterfaceDeclaration newClassDeclaration, NotificationChain msgs) {
        ClassOrInterfaceDeclaration oldClassDeclaration = classDeclaration;
        classDeclaration = newClassDeclaration;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.LOCAL_CLASS_DECLARATION_STMT__CLASS_DECLARATION, oldClassDeclaration, newClassDeclaration);
	...
	public void setClassDeclaration(ClassOrInterfaceDeclaration newClassDeclaration) {
        if (newClassDeclaration != classDeclaration) {
            ...
            if (classDeclaration != null)
                msgs = ((InternalEObject)classDeclaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.LOCAL_CLASS_DECLARATION_STMT__CLASS_DECLARATION, null, msgs);
            if (newClassDeclaration != null)
                msgs = ((InternalEObject)newClassDeclaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.LOCAL_CLASS_DECLARATION_STMT__CLASS_DECLARATION, null, msgs);
            msgs = basicSetClassDeclaration(newClassDeclaration, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.LOCAL_CLASS_DECLARATION_STMT__CLASS_DECLARATION, newClassDeclaration, newClassDeclaration));
    }
