...
public class MethodDeclarationImpl extends CallableDeclarationImpl implements MethodDeclaration {
    ...
    public NotificationChain basicSetType( Type newType, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.METHOD_DECLARATION__TYPE, oldType, newType );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newType != type ) {
            ...
            if( type != null )
                msgs = ( ( InternalEObject ) type ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.METHOD_DECLARATION__TYPE, null, msgs );
            if( newType != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.METHOD_DECLARATION__TYPE, newType,
                    newType ) );
    }
    ...
    public NotificationChain basicSetBody( BlockStmt newBody, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.METHOD_DECLARATION__BODY, oldBody, newBody );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newBody != body ) {
            ...
            if( body != null )
                msgs = ( ( InternalEObject ) body ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.METHOD_DECLARATION__BODY, null, msgs );
            if( newBody != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.METHOD_DECLARATION__BODY, newBody,
                    newBody ) );
    }
    ...
    public int eBaseStructuralFeatureID( int derivedFeatureID, Class< ? > baseClass ) {
        ...
        if( baseClass == NodeWithNativeModifier.class ) {
            switch( derivedFeatureID ) {
            case JavaPackage.METHOD_DECLARATION__NATIVE:
                return JavaPackage.NODE_WITH_NATIVE_MODIFIER__NATIVE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithSynchronizedModifier.class ) {
            switch( derivedFeatureID ) {
            case JavaPackage.METHOD_DECLARATION__SYNCHRONIZED:
                return JavaPackage.NODE_WITH_SYNCHRONIZED_MODIFIER__SYNCHRONIZED;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithDefaultModifier.class ) {
            switch( derivedFeatureID ) {
            case JavaPackage.METHOD_DECLARATION__DEFAULT:
                return JavaPackage.NODE_WITH_DEFAULT_MODIFIER__DEFAULT;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithType.class ) {
            ...
            case JavaPackage.NODE_WITH_TYPE__TYPE:
                return JavaPackage.METHOD_DECLARATION__TYPE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithBlockStmt.class ) {
            ...
            case JavaPackage.NODE_WITH_BLOCK_STMT__BODY:
                return JavaPackage.METHOD_DECLARATION__BODY;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithNativeModifier.class ) {
            switch( baseFeatureID ) {
            case JavaPackage.NODE_WITH_NATIVE_MODIFIER__NATIVE:
                return JavaPackage.METHOD_DECLARATION__NATIVE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithSynchronizedModifier.class ) {
            switch( baseFeatureID ) {
            case JavaPackage.NODE_WITH_SYNCHRONIZED_MODIFIER__SYNCHRONIZED:
                return JavaPackage.METHOD_DECLARATION__SYNCHRONIZED;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithDefaultModifier.class ) {
            switch( baseFeatureID ) {
            case JavaPackage.NODE_WITH_DEFAULT_MODIFIER__DEFAULT:
                return JavaPackage.METHOD_DECLARATION__DEFAULT;
            default:
                return -1;
            }
        }
