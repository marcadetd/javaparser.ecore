...
public class UnaryExprImpl extends ExpressionImpl implements UnaryExpr {
    ...
    public NotificationChain basicSetExpression( Expression newExpression, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.UNARY_EXPR__EXPRESSION, oldExpression, newExpression );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newExpression != expression ) {
            ...
            if( expression != null )
                msgs = ( ( InternalEObject ) expression ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.UNARY_EXPR__EXPRESSION, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.UNARY_EXPR__EXPRESSION, newExpression,
                    newExpression ) );
    }
    ...
    public void setOperator( UnaryOperator newOperator ) {
        ...
        if( eNotificationRequired() )
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.UNARY_EXPR__OPERATOR, oldOperator,
                    operator ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithExpression.class ) {
            ...
            case JavaPackage.NODE_WITH_EXPRESSION__EXPRESSION:
                return JavaPackage.UNARY_EXPR__EXPRESSION;
            default:
                return -1;
            }
        }
