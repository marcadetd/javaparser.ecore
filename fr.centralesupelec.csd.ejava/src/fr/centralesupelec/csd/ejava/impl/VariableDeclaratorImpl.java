 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.VariableDeclaratorImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.VariableDeclaratorImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.centralesupelec.csd.ejava.impl.VariableDeclaratorImpl#getInitializer <em>Initializer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableDeclaratorImpl extends JavaNodeImpl implements VariableDeclarator {
    ...
    protected EClass eStaticClass() {
        return EJavaPackage.Literals.VARIABLE_DECLARATOR;
    }
    ...
    public NotificationChain basicSetType( Type newType, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.VARIABLE_DECLARATOR__TYPE, oldType, newType );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newType != type ) {
            ...
            if( type != null )
                msgs = ( ( InternalEObject ) type ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.VARIABLE_DECLARATOR__TYPE, null, msgs );
            if( newType != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.VARIABLE_DECLARATOR__TYPE, newType,
                    newType ) );
    }
    ...
    public NotificationChain basicSetName( SimpleName newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.VARIABLE_DECLARATOR__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.VARIABLE_DECLARATOR__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.VARIABLE_DECLARATOR__NAME, newName,
                    newName ) );
    }
    ...
    public NotificationChain basicSetInitializer( Expression newInitializer, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    EJavaPackage.VARIABLE_DECLARATOR__INITIALIZER, oldInitializer, newInitializer );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newInitializer != initializer ) {
            ...
            if( initializer != null )
                msgs = ( ( InternalEObject ) initializer ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - EJavaPackage.VARIABLE_DECLARATOR__INITIALIZER, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, EJavaPackage.VARIABLE_DECLARATOR__INITIALIZER,
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithType.class ) {
            ...
            case EJavaPackage.NODE_WITH_TYPE__TYPE:
                return EJavaPackage.VARIABLE_DECLARATOR__TYPE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithSimpleName.class ) {
            ...
            case EJavaPackage.NODE_WITH_SIMPLE_NAME__NAME:
                return EJavaPackage.VARIABLE_DECLARATOR__NAME;
            default:
                return -1;
            }
        }
