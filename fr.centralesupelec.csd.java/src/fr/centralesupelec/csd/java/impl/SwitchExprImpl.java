...
public class SwitchExprImpl extends ExpressionImpl implements SwitchExpr {
	...
	public NotificationChain basicSetSelector(Expression newSelector, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JavaPackage.SWITCH_EXPR__SELECTOR, oldSelector, newSelector);
	...
	public void setSelector(Expression newSelector) {
        if (newSelector != selector) {
            ...
            if (selector != null)
                msgs = ((InternalEObject)selector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.SWITCH_EXPR__SELECTOR, null, msgs);
            if (newSelector != null)
                msgs = ((InternalEObject)newSelector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JavaPackage.SWITCH_EXPR__SELECTOR, null, msgs);
            msgs = basicSetSelector(newSelector, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.SWITCH_EXPR__SELECTOR, newSelector, newSelector));
    }
	...
	public EList<SwitchEntry> getEntries() {
        if (entries == null) {
            entries = new EObjectContainmentEList<SwitchEntry>(SwitchEntry.class, this, JavaPackage.SWITCH_EXPR__ENTRIES);
        }
        return entries;
    }
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == SwitchNode.class) {
            switch (derivedFeatureID) {
                case JavaPackage.SWITCH_EXPR__SELECTOR: return JavaPackage.SWITCH_NODE__SELECTOR;
                case JavaPackage.SWITCH_EXPR__ENTRIES: return JavaPackage.SWITCH_NODE__ENTRIES;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == SwitchNode.class) {
            switch (baseFeatureID) {
                case JavaPackage.SWITCH_NODE__SELECTOR: return JavaPackage.SWITCH_EXPR__SELECTOR;
                case JavaPackage.SWITCH_NODE__ENTRIES: return JavaPackage.SWITCH_EXPR__ENTRIES;
                default: return -1;
            }
        }
