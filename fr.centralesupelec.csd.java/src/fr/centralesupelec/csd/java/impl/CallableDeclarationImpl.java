...
public abstract class CallableDeclarationImpl extends BodyDeclarationImpl implements CallableDeclaration {
    ...
    public EList< ModifierKeyword > getModifiers() {
        if( modifiers == null ) {
            modifiers = new EDataTypeUniqueEList< ModifierKeyword >( ModifierKeyword.class, this,
                    JavaPackage.CALLABLE_DECLARATION__MODIFIERS );
        }
        return modifiers;
    }
    ...
    public NotificationChain basicSetName( SimpleName newName, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.CALLABLE_DECLARATION__NAME, oldName, newName );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newName != name ) {
            ...
            if( name != null )
                msgs = ( ( InternalEObject ) name ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.CALLABLE_DECLARATION__NAME, null, msgs );
            if( newName != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.CALLABLE_DECLARATION__NAME, newName,
                    newName ) );
    }
    ...
    public EList< Parameter > getParameters() {
        if( parameters == null ) {
            parameters = new EObjectContainmentEList< Parameter >( Parameter.class, this,
                    JavaPackage.CALLABLE_DECLARATION__PARAMETERS );
        }
        return parameters;
    }
    ...
    public EList< ReferenceType > getThrownExceptions() {
        if( thrownExceptions == null ) {
            thrownExceptions = new EObjectContainmentEList< ReferenceType >( ReferenceType.class, this,
                    JavaPackage.CALLABLE_DECLARATION__THROWN_EXCEPTIONS );
        }
    ...
    public EList< TypeParameter > getTypeParameters() {
        if( typeParameters == null ) {
            typeParameters = new EObjectContainmentEList< TypeParameter >( TypeParameter.class, this,
                    JavaPackage.CALLABLE_DECLARATION__TYPE_PARAMETERS );
        }
    ...
    public NotificationChain basicSetReceiverParameter( ReceiverParameter newReceiverParameter,
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.CALLABLE_DECLARATION__RECEIVER_PARAMETER, oldReceiverParameter, newReceiverParameter );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
        ...
        if( newReceiverParameter != receiverParameter ) {
            ...
            if( receiverParameter != null )
                msgs = ( ( InternalEObject ) receiverParameter ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.CALLABLE_DECLARATION__RECEIVER_PARAMETER, null, msgs );
            ...
            eNotify( new ENotificationImpl( this, Notification.SET,
                    JavaPackage.CALLABLE_DECLARATION__RECEIVER_PARAMETER, newReceiverParameter,
    ...
    public int eBaseStructuralFeatureID( int derivedFeatureID, Class< ? > baseClass ) {
        ...
        if( baseClass == NodeWithThrownExceptions.class ) {
            switch( derivedFeatureID ) {
            case JavaPackage.CALLABLE_DECLARATION__THROWN_EXCEPTIONS:
                return JavaPackage.NODE_WITH_THROWN_EXCEPTIONS__THROWN_EXCEPTIONS;
            default:
                return -1;
            }
        }
        ...
        if( baseClass == NodeWithStrictfpModifier.class ) {
            switch( derivedFeatureID ) {
            case JavaPackage.CALLABLE_DECLARATION__STRICTFP:
                return JavaPackage.NODE_WITH_STRICTFP_MODIFIER__STRICTFP;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithModifiers.class ) {
            ...
            case JavaPackage.NODE_WITH_MODIFIERS__MODIFIERS:
                return JavaPackage.CALLABLE_DECLARATION__MODIFIERS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithPublicModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_PUBLIC_MODIFIER__PUBLIC:
                return JavaPackage.CALLABLE_DECLARATION__PUBLIC;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithPrivateModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_PRIVATE_MODIFIER__PRIVATE:
                return JavaPackage.CALLABLE_DECLARATION__PRIVATE;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithProtectedModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_PROTECTED_MODIFIER__PROTECTED:
                return JavaPackage.CALLABLE_DECLARATION__PROTECTED;
            default:
                return -1;
            }
        }
        ...
        if( baseClass == NodeWithSimpleName.class ) {
            ...
            case JavaPackage.NODE_WITH_SIMPLE_NAME__NAME:
                return JavaPackage.CALLABLE_DECLARATION__NAME;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithParameters.class ) {
            ...
            case JavaPackage.NODE_WITH_PARAMETERS__PARAMETERS:
                return JavaPackage.CALLABLE_DECLARATION__PARAMETERS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithThrownExceptions.class ) {
            switch( baseFeatureID ) {
            case JavaPackage.NODE_WITH_THROWN_EXCEPTIONS__THROWN_EXCEPTIONS:
                return JavaPackage.CALLABLE_DECLARATION__THROWN_EXCEPTIONS;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithTypeParameters.class ) {
            ...
            case JavaPackage.NODE_WITH_TYPE_PARAMETERS__TYPE_PARAMETERS:
                return JavaPackage.CALLABLE_DECLARATION__TYPE_PARAMETERS;
            default:
                return -1;
            }
        }
        ...
        if( baseClass == NodeWithAbstractModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_ABSTRACT_MODIFIER__ABSTRACT:
                return JavaPackage.CALLABLE_DECLARATION__ABSTRACT;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithStaticModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_STATIC_MODIFIER__STATIC:
                return JavaPackage.CALLABLE_DECLARATION__STATIC;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithFinalModifier.class ) {
            ...
            case JavaPackage.NODE_WITH_FINAL_MODIFIER__FINAL:
                return JavaPackage.CALLABLE_DECLARATION__FINAL;
            default:
                return -1;
            }
        }
        if( baseClass == NodeWithStrictfpModifier.class ) {
            switch( baseFeatureID ) {
            case JavaPackage.NODE_WITH_STRICTFP_MODIFIER__STRICTFP:
                return JavaPackage.CALLABLE_DECLARATION__STRICTFP;
            default:
                return -1;
            }
        }
