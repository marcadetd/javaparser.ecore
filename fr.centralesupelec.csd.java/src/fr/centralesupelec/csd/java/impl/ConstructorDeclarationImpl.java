    ...
    public NotificationChain basicSetBody( BlockStmt newBody, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    JavaPackage.CONSTRUCTOR_DECLARATION__BODY, oldBody, newBody );
            if( msgs == null )
                msgs = notification;
            else
        ...
        if( newBody != body ) {
            ...
            if( body != null )
                msgs = ( ( InternalEObject ) body ).eInverseRemove( this,
                        EOPPOSITE_FEATURE_BASE - JavaPackage.CONSTRUCTOR_DECLARATION__BODY, null, msgs );
            if( newBody != null )
            ...
            eNotify( new ENotificationImpl( this, Notification.SET, JavaPackage.CONSTRUCTOR_DECLARATION__BODY, newBody,
                    newBody ) );
    }
    ...
    public int eDerivedStructuralFeatureID( int baseFeatureID, Class< ? > baseClass ) {
        if( baseClass == NodeWithBlockStmt.class ) {
            ...
            case JavaPackage.NODE_WITH_BLOCK_STMT__BODY:
                return JavaPackage.CONSTRUCTOR_DECLARATION__BODY;
            default:
                return -1;
            }
        }
